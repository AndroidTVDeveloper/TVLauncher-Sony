...
class TwilightManager {
    ...
    /* JADX INFO: Multiple debug info for r14v1 long: [D('yesterdaySunset' long), D('todaySunset' long)] */
    private void updateState(Location location) {
        ...
        if (todaySunrise2 == -1 || todaySunset2 == -1) {
            ...
            nextUpdate = nextUpdate2 + DefaultLoadErrorHandlingPolicy.DEFAULT_TRACK_BLACKLIST_MS;
        }
