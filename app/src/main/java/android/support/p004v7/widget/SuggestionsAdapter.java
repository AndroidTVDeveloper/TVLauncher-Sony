...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: androidx.cursoradapter.widget.ResourceCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, boolean):void
     arg types: [android.content.Context, int, ?[OBJECT, ARRAY], int]
     candidates:
      androidx.cursoradapter.widget.ResourceCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, int):void
      androidx.cursoradapter.widget.ResourceCursorAdapter.<init>(android.content.Context, int, android.database.Cursor, boolean):void */
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0207R.C0209id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0207R.C0209id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0207R.attr.textColorSearchUrl, colorValue, true);
    ...
    /* JADX INFO: Multiple debug info for r1v2 android.graphics.drawable.Drawable: [D('cached' android.graphics.drawable.Drawable$ConstantState), D('drawable' android.graphics.drawable.Drawable)] */
