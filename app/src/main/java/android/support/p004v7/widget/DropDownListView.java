...
class DropDownListView extends ListView {
    ...
    DropDownListView(Context context, boolean hijackFocus) {
        super(context, null, C0207R.attr.dropDownListViewStyle);
    ...
    /* JADX INFO: Multiple debug info for r2v2 int: [D('paddingTop' int), D('newType' int)] */
    /* JADX INFO: Multiple debug info for r19v1 int: [D('childLp' android.view.ViewGroup$LayoutParams), D('paddingBottom' int)] */
