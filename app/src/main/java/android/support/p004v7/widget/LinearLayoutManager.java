...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (this.mAnchorInfo.mLayoutFromEnd) {
            ...
            layoutState3.mExtraFillSpace = extraForEnd;
            ...
            if (this.mLayoutState.mAvailable > 0) {
                ...
                layoutState4.mExtraFillSpace = extraForStart2;
            ...
            layoutState5.mExtraFillSpace = extraForEnd;
            ...
            layoutState6.mExtraFillSpace = extraForStart;
            ...
            if (this.mLayoutState.mAvailable > 0) {
                ...
                layoutState7.mExtraFillSpace = extraForEnd2;
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace, boolean canUseExistingSpace, RecyclerView.State state) {
        ...
        LayoutState layoutState3 = this.mLayoutState;
        layoutState3.mAvailable = requiredSpace;
        if (canUseExistingSpace) {
            layoutState3.mAvailable -= scrollingOffset;
        }
    ...
    /* JADX INFO: Multiple debug info for r0v9 int: [D('top' int), D('right' int)] */
    /* JADX INFO: Multiple debug info for r1v2 int: [D('left' int), D('right' int)] */
    ...
    public View findOneVisibleChild(int fromIndex, int toIndex, boolean completelyVisible, boolean acceptPartiallyVisible) {
        ...
        if (completelyVisible) {
            ...
            preferredBoundsFlag = ClientAnalytics.LogRequest.LogSource.ANDROID_MIGRATE_VALUE;
        }
        if (acceptPartiallyVisible) {
            acceptableBoundsFlag = ClientAnalytics.LogRequest.LogSource.ANDROID_MIGRATE_VALUE;
        }
        if (this.mOrientation == 0) {
