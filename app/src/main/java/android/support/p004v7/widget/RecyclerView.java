...
import android.support.p001v4.view.NestedScrollingChild3;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    /* JADX INFO: Multiple debug info for r16v1 java.lang.String: [D('a' android.content.res.TypedArray), D('layoutManagerName' java.lang.String)] */
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attributeSet != null) {
            TypedArray a3 = context2.obtainStyledAttributes(attributeSet, CLIP_TO_PADDING_ATTR, i2, 0);
            this.mClipToPadding = a3.getBoolean(0, true);
            a3.recycle();
        } else {
        ...
        if (attributeSet != null) {
            TypedArray a4 = context2.obtainStyledAttributes(attributeSet, C0213R.styleable.RecyclerView, i2, 0);
            if (Build.VERSION.SDK_INT >= 29) {
                a = a4;
                defStyleRes = 0;
                i = 262144;
                saveAttributeDataForStyleable(context, C0213R.styleable.RecyclerView, attrs, a4, defStyle, 0);
            } else {
                a = a4;
                defStyleRes = 0;
                i = 262144;
            ...
            TypedArray a5 = a;
            String layoutManagerName = a5.getString(C0213R.styleable.RecyclerView_layoutManager);
            if (a5.getInt(C0213R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(i);
            }
            this.mEnableFastScroller = a5.getBoolean(C0213R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a5.getDrawable(C0213R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a5.getDrawable(C0213R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a5.getDrawable(C0213R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a5.getDrawable(C0213R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a5.recycle();
            createLayoutManager(context, layoutManagerName, attrs, defStyle, defStyleRes);
            if (Build.VERSION.SDK_INT >= 21) {
                int defStyleRes2 = defStyleRes;
                TypedArray a6 = context2.obtainStyledAttributes(attributeSet, NESTED_SCROLLING_ATTRS, i2, defStyleRes2);
                if (Build.VERSION.SDK_INT >= 29) {
                    a2 = a6;
                    saveAttributeDataForStyleable(context, NESTED_SCROLLING_ATTRS, attrs, a6, defStyle, defStyleRes2);
                } else {
                    a2 = a6;
                }
                boolean nestedScrollingEnabled2 = a2.getBoolean(0, true);
                a2.recycle();
        ...
        if (className != null) {
            ...
            if (!className2.isEmpty()) {
                ...
                try {
                    ...
                    Class<? extends LayoutManager> layoutManagerClass = Class.forName(className3, false, classLoader).asSubclass(LayoutManager.class);
                    Object[] constructorArgs = null;
                    try {
                        Constructor<? extends LayoutManager> constructor2 = layoutManagerClass.getConstructor(LAYOUT_MANAGER_CONSTRUCTOR_SIGNATURE);
    ...
    public boolean scrollByInternal(int r22, int r23, android.view.MotionEvent r24) {
        ...
        L_0x002d:
            ...
            r6 = r3
        L_0x0031:
            java.util.ArrayList<android.support.v7.widget.RecyclerView$ItemDecoration> r0 = r8.mItemDecorations
        ...
        L_0x003c:
            ...
            boolean r0 = android.support.p001v4.view.MotionEventCompat.isFromSource(r11, r0)
        ...
        L_0x00b4:
            boolean r0 = r21.awakenScrollBars()
        ...
        L_0x00c3:
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.RecyclerView.scrollByInternal(int, int, android.view.MotionEvent):boolean");
    }
                ...
                if (direction != 17) {
                    if (direction != 33) {
                        if (direction != 66) {
                            ...
                            } else return downness > 0;
                        } else return rightness > 0;
                    } else return downness < 0;
                } else return rightness < 0;
            } else return downness > 0 || (downness == 0 && rightness * rtl >= 0);
        } else return downness < 0 || (downness == 0 && rightness * rtl <= 0);
    }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        if (action == 0) {
            ...
            int y3 = y2;
            int x3 = x2;
            if (dispatchNestedPreScroll(dx3, dy3, iArr3, this.mScrollOffset, 0)) {
            ...
            if (this.mScrollState != 1) {
                boolean startScroll = false;
                if (canScrollHorizontally && Math.abs(dx) > (i2 = this.mTouchSlop)) {
                    if (dx > 0) {
                        dx -= i2;
                    } else {
                        dx += i2;
                ...
                if (canScrollVertically && Math.abs(dy) > (i = this.mTouchSlop)) {
                    if (dy > 0) {
                        dy -= i;
                    } else {
                        dy += i;
            ...
            if (this.mScrollState == 1) {
                ...
                if (scrollByInternal(i5, i3, motionEvent)) {
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
    ...
    /* JADX INFO: Multiple debug info for r2v2 int: [D('i' int), D('limit' int)] */
    ...
    private boolean didChildRangeChange(int minPositionPreLayout, int maxPositionPreLayout) {
        findMinMaxChildLayoutPositions(this.mMinMaxLayoutPositions);
        int[] iArr = this.mMinMaxLayoutPositions;
        return iArr[0] != minPositionPreLayout || iArr[1] != maxPositionPreLayout;
    }
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if ((smoothScroller2 != null && smoothScroller2.isPendingInitialRun()) || !doneScrolling) {
                    ...
                    if (RecyclerView.this.mGapWorker != null) {
                        RecyclerView.this.mGapWorker.postFromTraversal(RecyclerView.this, unconsumedX2, unconsumedY2);
                    }
                } else {
                    if (RecyclerView.this.getOverScrollMode() != 2) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static void clearNestedRecyclerViewIfNotNested(android.support.p004v7.widget.RecyclerView.ViewHolder r3) {
        /*
        ...
        L_0x0024:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.RecyclerView.clearNestedRecyclerViewIfNotNested(android.support.v7.widget.RecyclerView$ViewHolder):void");
    }
        ...
        public void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                ...
                if ((RecyclerView.this.mAdapter != null && transientStatePreventsRecycling && RecyclerView.this.mAdapter.onFailedToRecycleView(holder)) || holder.isRecyclable()) {
                    if (this.mViewCacheMax > 0 && !holder.hasAnyOfTheFlags(ClientAnalytics.LogRequest.LogSource.SESAME_UNLOCK_PRIMES_VALUE)) {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH r4, int r5) {
            ...
            L_0x000e:
                ...
                boolean r2 = r0 instanceof android.support.p004v7.widget.RecyclerView.LayoutParams
                if (r2 == 0) goto L_0x0032
                r2 = r0
                android.support.v7.widget.RecyclerView$LayoutParams r2 = (android.support.p004v7.widget.RecyclerView.LayoutParams) r2
                r2.mInsetsDirty = r1
            L_0x0032:
                android.support.p001v4.p003os.TraceCompat.endSection()
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.RecyclerView.Adapter.bindViewHolder(android.support.v7.widget.RecyclerView$ViewHolder, int):void");
        }
    ...
    public static abstract class LayoutManager {
        ...
        private static boolean isMeasurementUpToDate(int childSize, int spec, int dimension) {
            ...
            } else return specSize >= childSize;
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0213R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0213R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0213R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0213R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0213R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public int getAdapterPositionFor(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(ClientAnalytics.LogRequest.LogSource.DMAGENT_IOS_VALUE) || !viewHolder.isBound()) {
            return -1;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0213R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0213R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0213R.dimen.fastscroll_margin));
    }
