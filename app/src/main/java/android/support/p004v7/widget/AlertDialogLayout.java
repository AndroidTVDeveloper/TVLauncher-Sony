...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* JADX INFO: Multiple debug info for r3v11 int: [D('remainingHeight' int), D('childHeightSpec' int)] */
    /* JADX INFO: Multiple debug info for r3v15 int: [D('remainingHeight' int), D('childHeightSpec' int)] */
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0207R.C0209id.topPanel) {
                    topPanel = child;
                } else if (id == C0207R.C0209id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0207R.C0209id.contentPanel && id != C0207R.C0209id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
