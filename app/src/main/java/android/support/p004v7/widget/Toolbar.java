...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attrs) {
        this(context, attrs, C0207R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0207R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C0207R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C0207R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C0207R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = a.getInteger(C0207R.styleable.Toolbar_buttonGravity, 48);
        int titleMargin = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_titleMargin, 0);
        titleMargin = a.hasValue(C0207R.styleable.Toolbar_titleMargins) ? a.getDimensionPixelOffset(C0207R.styleable.Toolbar_titleMargins, titleMargin) : titleMargin;
        ...
        int marginStart = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            this.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            this.mTitleMarginBottom = marginBottom;
        }
        this.mMaxButtonHeight = a.getDimensionPixelSize(C0207R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int contentInsetLeft = a.getDimensionPixelSize(C0207R.styleable.Toolbar_contentInsetLeft, 0);
        int contentInsetRight = a.getDimensionPixelSize(C0207R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        this.mCollapseIcon = a.getDrawable(C0207R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = a.getText(C0207R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C0207R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C0207R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        this.mPopupContext = getContext();
        setPopupTheme(a.getResourceId(C0207R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C0207R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C0207R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        Drawable logo = a.getDrawable(C0207R.styleable.Toolbar_logo);
        if (logo != null) {
            setLogo(logo);
        }
        CharSequence logoDesc = a.getText(C0207R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(logoDesc)) {
            setLogoDescription(logoDesc);
        }
        if (a.hasValue(C0207R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(a.getColorStateList(C0207R.styleable.Toolbar_titleTextColor));
        }
        if (a.hasValue(C0207R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColorStateList(C0207R.styleable.Toolbar_subtitleTextColor));
        }
        if (a.hasValue(C0207R.styleable.Toolbar_menu)) {
            inflateMenu(a.getResourceId(C0207R.styleable.Toolbar_menu, 0));
        }
        a.recycle();
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0207R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0207R.attr.toolbarNavigationButtonStyle);
    ...
    /* JADX INFO: Multiple debug info for r9v5 int: [D('menuWidth' int), D('height' int)] */
    /* JADX INFO: Multiple debug info for r9v9 int: [D('menuWidth' int), D('height' int)] */
    /* access modifiers changed from: protected */
    ...
    public void onLayout(boolean r34, int r35, int r36, int r37, int r38) {
        ...
        L_0x00d8:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r13 = (android.support.p004v7.widget.Toolbar.LayoutParams) r13
            r21 = r15
        ...
        L_0x010b:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r7 = (android.support.p004v7.widget.Toolbar.LayoutParams) r7
        ...
        L_0x0144:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r15 = (android.support.p004v7.widget.Toolbar.LayoutParams) r15
        ...
        L_0x01e0:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r14 = (android.support.p004v7.widget.Toolbar.LayoutParams) r14
            r18 = r4
        ...
        L_0x0229:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r4 = (android.support.p004v7.widget.Toolbar.LayoutParams) r4
            int r5 = r4.topMargin
            int r2 = r2 + r5
        ...
        L_0x02a7:
            ...
            android.support.v7.widget.Toolbar$LayoutParams r1 = (android.support.p004v7.widget.Toolbar.LayoutParams) r1
            int r5 = r1.topMargin
            int r2 = r2 + r5
            android.widget.TextView r5 = r0.mSubtitleTextView
            int r5 = r5.getMeasuredWidth()
        ...
        L_0x0363:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.Toolbar.onLayout(boolean, int, int, int, int):void");
    }
