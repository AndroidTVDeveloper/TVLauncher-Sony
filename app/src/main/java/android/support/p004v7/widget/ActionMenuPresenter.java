...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0207R.layout.abc_action_menu_layout, C0207R.layout.abc_action_menu_item_layout);
    }
    ...
    /* JADX WARN: Type inference failed for: r2v3, types: [android.view.Menu] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean onSubMenuSelected(android.support.p004v7.view.menu.SubMenuBuilder r8) {
        /*
            r7 = this;
        ...
        L_0x0009:
            ...
            android.view.Menu r2 = r0.getParentMenu()
            r0 = r2
            android.support.v7.view.menu.SubMenuBuilder r0 = (android.support.p004v7.view.menu.SubMenuBuilder) r0
            goto L_0x0009
        L_0x0019:
        ...
        L_0x004b:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.widget.ActionMenuPresenter.onSubMenuSelected(android.support.v7.view.menu.SubMenuBuilder):boolean");
    }
    ...
    /* JADX INFO: Multiple debug info for r2v7 android.view.View: [D('v' android.view.View), D('isAction' boolean)] */
    /* JADX INFO: Multiple debug info for r22v9 int: [D('isAction' boolean), D('measuredWidth' int)] */
    /* JADX INFO: Multiple debug info for r2v22 int: [D('v' android.view.View), D('groupId' int)] */
    public boolean flagActionItems() {
        ...
        int i3 = 0;
        while (i3 < itemsSize) {
            MenuItemImpl item2 = (MenuItemImpl) visibleItems.get(i3);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0207R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
            super(context, menu, anchorView, overflowOnly, C0207R.attr.actionOverflowMenuStyle);
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu, View anchorView) {
            super(context, subMenu, anchorView, false, C0207R.attr.actionOverflowMenuStyle);
