...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0207R.layout.abc_tooltip, (ViewGroup) null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0207R.C0209id.message);
        ...
        layoutParams.windowAnimations = C0207R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, WindowManager.LayoutParams outParams) {
        ...
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0207R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            int offsetExtra2 = this.mContext.getResources().getDimensionPixelOffset(C0207R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = this.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0207R.dimen.tooltip_y_offset_touch : C0207R.dimen.tooltip_y_offset_non_touch);
