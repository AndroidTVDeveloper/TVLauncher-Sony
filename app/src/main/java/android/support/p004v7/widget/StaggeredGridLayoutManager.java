...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    /* JADX INFO: Multiple debug info for r3v1 boolean: [D('targetPos' int), D('clipToPadding' boolean)] */
        ...
        while (true) {
            if (layoutState.hasMore(state)) {
                ...
                if (layoutState2.mLayoutDirection == z) {
                    ...
                    if (lp.mFullSpan != 0) {
                        end2 = getMinStart(defaultNewViewLine);
                    } else {
                        end2 = currentSpan.getStartLine(defaultNewViewLine);
                    }
                    int start3 = end2 - this.mPrimaryOrientation.getDecoratedMeasurement(view);
                    if (assignSpan && lp.mFullSpan) {
                ...
                if (!isLayoutRTL() || this.mOrientation != z) {
                    if (lp.mFullSpan != 0) {
                        ...
                        otherStart2 = (currentSpan.mIndex * this.mSizePerSpan) + this.mSecondaryOrientation.getStartAfterPadding();
                    }
