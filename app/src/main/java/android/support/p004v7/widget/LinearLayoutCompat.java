...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0207R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        int index = a.getInt(C0207R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        int index2 = a.getInt(C0207R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index2 >= 0) {
            setGravity(index2);
        }
        boolean baselineAligned = a.getBoolean(C0207R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0207R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0207R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0207R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0207R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0207R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0207R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
    ...
    /* JADX INFO: Multiple debug info for r20v1 int: [D('count' int), D('weightedMaxWidth' int)] */
    ...
    /* JADX INFO: Multiple debug info for r0v29 int: [D('matchWidthLocally' boolean), D('alternativeMaxWidth' int)] */
    ...
    /* JADX INFO: Multiple debug info for r6v4 int: [D('baselineAligned' boolean), D('childState' int)] */
    ...
    /* JADX INFO: Multiple debug info for r1v3 int: [D('alternativeMaxHeight' int), D('largestChildWidth' int)] */
    /* JADX INFO: Multiple debug info for r12v6 android.view.View: [D('weightedMaxHeight' int), D('child' android.view.View)] */
    /* JADX INFO: Multiple debug info for r0v14 int: [D('alternativeMaxHeight' int), D('weightSum' float)] */
    ...
    /* JADX INFO: Multiple debug info for r2v42 int: [D('margin' int), D('maxHeight' int)] */
    /* JADX INFO: Multiple debug info for r1v38 int: [D('alternativeMaxHeight' int), D('lp' android.support.v7.widget.LinearLayoutCompat$LayoutParams)] */
    /* access modifiers changed from: package-private */
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0207R.styleable.LinearLayoutCompat_Layout);
            this.weight = a.getFloat(C0207R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = a.getInt(C0207R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            a.recycle();
        }
