...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0207R.layout.abc_cascading_menu_item_layout;
    ...
    public CascadingMenuPopup(Context context, View anchor, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0207R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) inflater.inflate(C0207R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    /* JADX WARN: Type inference failed for: r6v4, types: [android.widget.ListAdapter] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private android.view.View findParentViewForSubmenu(android.support.p004v7.view.menu.CascadingMenuPopup.CascadingMenuInfo r11, android.support.p004v7.view.menu.MenuBuilder r12) {
        /*
            r10 = this;
        ...
        L_0x000a:
            ...
            r4 = r6
            android.support.v7.view.menu.MenuAdapter r4 = (android.support.p004v7.view.menu.MenuAdapter) r4
            goto L_0x0029
        L_0x0025:
            r5 = 0
            r4 = r3
        ...
        L_0x002f:
            ...
            android.support.v7.view.menu.MenuItemImpl r9 = r4.getItem(r7)
        ...
        L_0x0055:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.view.menu.CascadingMenuPopup.findParentViewForSubmenu(android.support.v7.view.menu.CascadingMenuPopup$CascadingMenuInfo, android.support.v7.view.menu.MenuBuilder):android.view.View");
    }
