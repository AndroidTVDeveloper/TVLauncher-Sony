...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0207R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0207R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0207R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0207R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0207R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0207R.styleable.MenuView_subMenuArrow);
        TypedArray b = context.getTheme().obtainStyledAttributes(null, new int[]{16843049}, C0207R.attr.dropDownListViewStyle, 0);
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0207R.C0209id.title);
        int i = this.mTextAppearance;
        if (i != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, i);
        }
        this.mShortcutView = (TextView) findViewById(C0207R.C0209id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0207R.C0209id.submenuarrow);
        ImageView imageView = this.mSubMenuArrowView;
        if (imageView != null) {
            imageView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0207R.C0209id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0207R.C0209id.content);
    }
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0207R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
    ...
    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0207R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
    ...
    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0207R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
