...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, null, false, C0207R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView) {
        this(context, menu, anchorView, false, C0207R.attr.popupMenuStyle, 0);
    }
    ...
    private android.support.p004v7.view.menu.MenuPopup createPopup() {
        ...
        L_0x0021:
            ...
            int r5 = android.support.p004v7.appcompat.C0207R.dimen.abc_cascading_menus_min_smallest_width
