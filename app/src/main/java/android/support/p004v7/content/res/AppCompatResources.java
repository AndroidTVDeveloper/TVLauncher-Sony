package android.support.p004v7.content.res;
...
import android.support.p001v4.content.res.ColorStateListInflaterCompat;
...
public final class AppCompatResources {
    ...
    private static android.content.res.ColorStateList getCachedColorStateList(android.content.Context r5, int r6) {
        /*
            java.lang.Object r0 = android.support.p004v7.content.res.AppCompatResources.sColorStateCacheLock
            monitor-enter(r0)
            java.util.WeakHashMap<android.content.Context, android.util.SparseArray<android.support.v7.content.res.AppCompatResources$ColorStateListCacheEntry>> r1 = android.support.p004v7.content.res.AppCompatResources.sColorStateCaches     // Catch:{ all -> 0x0035 }
            ...
            android.support.v7.content.res.AppCompatResources$ColorStateListCacheEntry r2 = (android.support.p004v7.content.res.AppCompatResources.ColorStateListCacheEntry) r2     // Catch:{ all -> 0x0035 }
            if (r2 == 0) goto L_0x0032
        ...
        L_0x0035:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p004v7.content.res.AppCompatResources.getCachedColorStateList(android.content.Context, int):android.content.res.ColorStateList");
    }
