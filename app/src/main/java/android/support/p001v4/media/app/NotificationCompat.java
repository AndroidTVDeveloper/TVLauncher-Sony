...
import android.support.mediacompat.C0026R;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        public RemoteViews generateContentView() {
            ...
            view.removeAllViews(C0026R.C0028id.media_actions);
            if (numActionsInCompact > 0) {
                int i = 0;
                while (i < numActionsInCompact) {
                    if (i < numActions) {
                        view.addView(C0026R.C0028id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                        i++;
                    } else {
            ...
            if (this.mShowCancelButton) {
                view.setViewVisibility(C0026R.C0028id.end_padder, 8);
                view.setViewVisibility(C0026R.C0028id.cancel_action, 0);
                view.setOnClickPendingIntent(C0026R.C0028id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C0026R.C0028id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0026R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C0026R.C0028id.end_padder, 0);
                view.setViewVisibility(C0026R.C0028id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0026R.layout.notification_media_action);
            button.setImageViewResource(C0026R.C0028id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C0026R.C0028id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0026R.C0028id.action0, action.getTitle());
            }
            return button;
        }
        ...
        public int getContentViewLayoutResource() {
            return C0026R.layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C0026R.C0028id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C0026R.C0028id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton != 0) {
                big.setViewVisibility(C0026R.C0028id.cancel_action, 0);
                big.setInt(C0026R.C0028id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0026R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C0026R.C0028id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C0026R.C0028id.cancel_action, 8);
            }
            return big;
        }
        ...
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0026R.layout.notification_template_big_media_narrow : C0026R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0026R.layout.notification_template_media_custom;
            }
        ...
        /* access modifiers changed from: package-private */
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0026R.layout.notification_template_big_media_narrow_custom : C0026R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0026R.color.notification_material_background_media_default_color);
            }
            views.setInt(C0026R.C0028id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
}
