...
public class MediaSessionCompat {
            ...
            if (!doesBundleHaveCustomParcelable(sessionInfo)) {
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    if (Build.VERSION.SDK_INT >= 29) {
                        this.mImpl = new MediaSessionImplApi29(sessionFwk, session2Token, sessionInfo);
                    } else if (Build.VERSION.SDK_INT >= 28) {
                        this.mImpl = new MediaSessionImplApi28(sessionFwk, session2Token, sessionInfo);
                    } else {
                        this.mImpl = new MediaSessionImplApi21(sessionFwk, session2Token, sessionInfo);
                    }
    ...
    public static boolean doesBundleHaveCustomParcelable(Bundle bundle) {
        ...
        try {
            ...
            parcel.readBundle(null).isEmpty();
            if (parcel != null) {
                parcel.recycle();
            }
            return false;
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        MediaSessionImplApi21(MediaSession sessionFwk, VersionedParcelable session2Token, Bundle sessionInfo) {
            this.mSessionFwk = sessionFwk;
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        MediaSessionImplApi28(MediaSession sessionFwk, VersionedParcelable session2Token, Bundle sessionInfo) {
    ...
    static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        MediaSessionImplApi29(MediaSession sessionFwk, VersionedParcelable session2Token, Bundle sessionInfo) {
            super(sessionFwk, session2Token, sessionInfo);
        }
