...
public final class PaintCompat {
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [android.graphics.Xfermode] */
    /* JADX WARN: Type inference failed for: r2v3, types: [android.graphics.BlendMode] */
    /* JADX WARN: Type inference failed for: r2v5 */
    /* JADX WARN: Type inference failed for: r2v6 */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static boolean setBlendMode(android.graphics.Paint r4, android.support.p001v4.graphics.BlendModeCompat r5) {
        /*
            ...
            android.graphics.BlendMode r2 = android.support.p001v4.graphics.BlendModeUtils.obtainBlendModeFromCompat(r5)
        L_0x000e:
            r4.setBlendMode(r2)
            return r1
        L_0x0012:
            if (r5 == 0) goto L_0x0027
            android.graphics.PorterDuff$Mode r0 = android.support.p001v4.graphics.BlendModeUtils.obtainPorterDuffFromCompat(r5)
        ...
        L_0x0027:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.graphics.PaintCompat.setBlendMode(android.graphics.Paint, android.support.v4.graphics.BlendModeCompat):boolean");
    }
