...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public AutoScrollHelper(View target) {
        ...
        setRampUpDuration(ClientAnalytics.LogRequest.LogSource.GOR_ANDROID_PRIMES_VALUE);
    ...
    public boolean onTouch(android.view.View r8, android.view.MotionEvent r9) {
        ...
        L_0x0063:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.widget.AutoScrollHelper.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }
