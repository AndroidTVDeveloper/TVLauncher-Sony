...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord bse) {
        ...
        if (bse.mAddToBackStack) {
            ...
            int opNum = 0;
            while (opNum < numOps) {
                FragmentTransaction.C0058Op op = (FragmentTransaction.C0058Op) bse.mOps.get(opNum);
                int pos2 = pos + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fm) {
        ...
        while (pos < this.mOps.length) {
            FragmentTransaction.C0058Op op = new FragmentTransaction.C0058Op();
            int pos2 = pos + 1;
            ...
            int[] iArr = this.mOps;
            int pos3 = pos2 + 1;
            op.mEnterAnim = iArr[pos2];
            int pos4 = pos3 + 1;
            op.mExitAnim = iArr[pos3];
            int pos5 = pos4 + 1;
            op.mPopEnterAnim = iArr[pos4];
            op.mPopExitAnim = iArr[pos5];
