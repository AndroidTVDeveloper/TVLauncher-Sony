...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0014R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0014R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:86:0x0240  */
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r20, int r21, boolean r22) {
            ...
            L_0x0028:
                ...
                int r9 = android.support.compat.C0014R.C0016id.notification_background
                int r10 = android.support.compat.C0014R.C0015drawable.notification_bg_low
                r2.setInt(r9, r6, r10)
                int r9 = android.support.compat.C0014R.C0016id.icon
                int r10 = android.support.compat.C0014R.C0015drawable.notification_template_icon_low_bg
                r2.setInt(r9, r6, r10)
                goto L_0x0057
            L_0x0049:
                int r9 = android.support.compat.C0014R.C0016id.notification_background
                int r10 = android.support.compat.C0014R.C0015drawable.notification_bg
                r2.setInt(r9, r6, r10)
                int r9 = android.support.compat.C0014R.C0016id.icon
                int r10 = android.support.compat.C0014R.C0015drawable.notification_template_icon_bg
                r2.setInt(r9, r6, r10)
            L_0x0057:
                android.support.v4.app.NotificationCompat$Builder r6 = r0.mBuilder
                ...
                int r6 = android.support.compat.C0014R.C0016id.icon
            ...
            L_0x0077:
                ...
                int r6 = android.support.compat.C0014R.dimen.notification_right_icon_size
                int r6 = r1.getDimensionPixelSize(r6)
                int r9 = android.support.compat.C0014R.dimen.notification_small_icon_background_padding
                ...
                int r10 = android.support.compat.C0014R.C0016id.right_icon
            ...
            L_0x00ab:
                ...
                r2.setImageViewBitmap(r10, r7)
            L_0x00ba:
                int r7 = android.support.compat.C0014R.C0016id.right_icon
            ...
            L_0x00c0:
                ...
                int r6 = android.support.compat.C0014R.dimen.notification_large_icon_width
                int r6 = r1.getDimensionPixelSize(r6)
                int r7 = android.support.compat.C0014R.dimen.notification_big_circle_margin
                int r7 = r1.getDimensionPixelSize(r7)
                int r6 = r6 - r7
                int r7 = android.support.compat.C0014R.dimen.notification_small_icon_size_as_large
                int r7 = r1.getDimensionPixelSize(r7)
                android.support.v4.app.NotificationCompat$Builder r9 = r0.mBuilder
                ...
                int r10 = android.support.compat.C0014R.C0016id.icon
            ...
            L_0x010b:
                ...
                int r6 = android.support.compat.C0014R.C0016id.title
                android.support.v4.app.NotificationCompat$Builder r7 = r0.mBuilder
            ...
            L_0x011a:
                ...
                int r6 = android.support.compat.C0014R.C0016id.text
                android.support.v4.app.NotificationCompat$Builder r7 = r0.mBuilder
            ...
            L_0x0137:
                ...
                int r7 = android.support.compat.C0014R.C0016id.info
            ...
            L_0x014f:
                ...
                int r7 = android.support.compat.C0014R.integer.status_bar_notification_info_maxnum
                int r7 = r1.getInteger(r7)
                android.support.v4.app.NotificationCompat$Builder r8 = r0.mBuilder
                int r8 = r8.mNumber
                if (r8 <= r7) goto L_0x016d
                int r8 = android.support.compat.C0014R.C0016id.info
                int r9 = android.support.compat.C0014R.string.status_bar_notification_info_overflow
                java.lang.String r9 = r1.getString(r9)
                r2.setTextViewText(r8, r9)
                goto L_0x017f
            L_0x016d:
                java.text.NumberFormat r8 = java.text.NumberFormat.getIntegerInstance()
                int r9 = android.support.compat.C0014R.C0016id.info
                android.support.v4.app.NotificationCompat$Builder r10 = r0.mBuilder
                int r10 = r10.mNumber
                long r10 = (long) r10
            ...
            L_0x018e:
                ...
                int r6 = android.support.compat.C0014R.C0016id.text2
                android.support.v4.app.NotificationCompat$Builder r7 = r0.mBuilder
                java.lang.CharSequence r7 = r7.mContentText
                r2.setTextViewText(r6, r7)
                int r6 = android.support.compat.C0014R.C0016id.text2
            ...
            L_0x01c0:
                ...
                int r5 = android.support.compat.C0014R.dimen.notification_subtext_size
                int r5 = r1.getDimensionPixelSize(r5)
                float r5 = (float) r5
                int r6 = android.support.compat.C0014R.C0016id.text
                r2.setTextViewTextSize(r6, r12, r5)
            L_0x01d4:
                int r6 = android.support.compat.C0014R.C0016id.line1
                r7 = 0
                r8 = 0
                r9 = 0
                r10 = 0
            ...
            L_0x01de:
                ...
                int r5 = android.os.Build.VERSION.SDK_INT
                if (r5 < r14) goto L_0x021c
                int r5 = android.support.compat.C0014R.C0016id.chronometer
                ...
                goto L_0x022f
            L_0x021c:
                int r5 = android.support.compat.C0014R.C0016id.time
                r2.setViewVisibility(r5, r12)
                int r5 = android.support.compat.C0014R.C0016id.time
                android.support.v4.app.NotificationCompat$Builder r6 = r0.mBuilder
                long r6 = r6.getWhenIfShowing()
            ...
            L_0x022f:
                r11 = 1
            L_0x0230:
                int r5 = android.support.compat.C0014R.C0016id.right_side
            ...
            L_0x0238:
                ...
                int r5 = android.support.compat.C0014R.C0016id.line3
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0014R.C0016id.notification_main_column);
            outerView.addView(C0014R.C0016id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0014R.C0016id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0014R.C0016id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0014R.C0016id.title, 8);
            outerView.setViewVisibility(C0014R.C0016id.text2, 8);
            outerView.setViewVisibility(C0014R.C0016id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0014R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0014R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            RemoteViews remoteViews = applyStandardTemplate(true, C0014R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0014R.C0016id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    remoteViews.addView(C0014R.C0016id.actions, generateActionButton(nonContextualActions.get(i)));
                }
            }
            if (!actionsVisible) {
                actionVisibility = 8;
            }
            remoteViews.setViewVisibility(C0014R.C0016id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0014R.C0016id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0014R.layout.notification_action_tombstone : C0014R.layout.notification_action);
            button.setImageViewBitmap(C0014R.C0016id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0014R.color.notification_action_color_filter)));
            button.setTextViewText(C0014R.C0016id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0014R.C0016id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0014R.C0016id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static class Action {
        ...
        public Action(int icon2, CharSequence title2, PendingIntent intent) {
            this(icon2, title2, intent, new Bundle(), null, null, true, 0, true, false);
        }
        ...
        public static final class Builder {
            ...
            private Builder(int icon, CharSequence title, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual) {
            ...
            /* Code decompiled incorrectly, please refer to instructions dump. */
            public android.support.p001v4.app.NotificationCompat.Action build() {
                /*
                    r15 = this;
                    ...
                    r1.<init>()
                    java.util.ArrayList<android.support.v4.app.RemoteInput> r2 = r15.mRemoteInputs
                ...
                L_0x0015:
                    ...
                    android.support.v4.app.RemoteInput r3 = (android.support.p001v4.app.RemoteInput) r3
                ...
                L_0x0038:
                    int r2 = r0.size()
                    android.support.v4.app.RemoteInput[] r2 = new android.support.p001v4.app.RemoteInput[r2]
                    java.lang.Object[] r2 = r0.toArray(r2)
                    android.support.v4.app.RemoteInput[] r2 = (android.support.p001v4.app.RemoteInput[]) r2
                    r10 = r2
                L_0x0045:
                ...
                L_0x005c:
                    ...
                    return r2
                */
                throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.app.NotificationCompat.Action.Builder.build():android.support.v4.app.NotificationCompat$Action");
            }
        }
    ...
    /* renamed from: android.support.v4.app.NotificationCompat$BubbleMetadata */
    public static final class BubbleMetadata {
        ...
        /* renamed from: android.support.v4.app.NotificationCompat$BubbleMetadata$Builder */
        public static final class Builder {
            private PendingIntent mDeleteIntent;
            private int mDesiredHeight;
            private int mDesiredHeightResId;
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.support.p001v4.app.NotificationCompat.Action getAction(android.app.Notification r6, int r7) {
        /*
        ...
        L_0x002b:
            ...
            android.support.v4.app.NotificationCompat$Action r3 = android.support.p001v4.app.NotificationCompatJellybean.readAction(r3, r4, r5, r1)
            return r3
        L_0x0036:
            int r0 = android.os.Build.VERSION.SDK_INT
            r1 = 16
            if (r0 < r1) goto L_0x0041
            android.support.v4.app.NotificationCompat$Action r0 = android.support.p001v4.app.NotificationCompatJellybean.getAction(r6, r7)
            return r0
        L_0x0041:
            r0 = 0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.app.NotificationCompat.getAction(android.app.Notification, int):android.support.v4.app.NotificationCompat$Action");
    }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (srcArray == null) {
            ...
            for (int i = 0; i < srcArray.length; i++) {
                ...
                remoteInputs[i] = new RemoteInput(src.getResultKey(), src.getLabel(), src.getChoices(), src.getAllowFreeFormInput(), Build.VERSION.SDK_INT >= 29 ? src.getEditChoicesBeforeSending() : 0, src.getExtras(), null);
            }
        }
        if (Build.VERSION.SDK_INT >= 24) {
