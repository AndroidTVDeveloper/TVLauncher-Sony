...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long r27, int r29) {
        /*
            r0 = r27
            r2 = r29
            char[] r3 = android.support.p001v4.util.TimeUtils.sFormatStr
            int r3 = r3.length
            if (r3 >= r2) goto L_0x000d
            char[] r3 = new char[r2]
            android.support.p001v4.util.TimeUtils.sFormatStr = r3
        L_0x000d:
            char[] r3 = android.support.p001v4.util.TimeUtils.sFormatStr
            r4 = 32
            r5 = 0
        ...
        L_0x0139:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.util.TimeUtils.formatDurationLocked(long, int):int");
    }
