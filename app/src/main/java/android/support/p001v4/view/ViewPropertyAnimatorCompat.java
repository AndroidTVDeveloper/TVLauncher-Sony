...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo2880x(float value) {
        View view = this.mView.get();
        View view2 = view;
        if (view != null) {
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo2882y(float value) {
        View view = this.mView.get();
        View view2 = view;
        if (view != null) {
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo2884z(float value) {
        View view = this.mView.get();
        View view2 = view;
        if (view != null && Build.VERSION.SDK_INT >= 21) {
