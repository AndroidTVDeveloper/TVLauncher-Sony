...
public class ViewCompat {
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (ArrayList) view.getTag(C0014R.C0016id.tag_accessibility_actions);
        if (actions != null) {
            return actions;
        }
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions2 = new ArrayList<>();
        view.setTag(C0014R.C0016id.tag_accessibility_actions, actions2);
        return actions2;
    }
    ...
    public static void addOnUnhandledKeyEventListener(View v, final OnUnhandledKeyEventListenerCompat listener) {
        if (Build.VERSION.SDK_INT >= 28) {
            SimpleArrayMap<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (SimpleArrayMap) v.getTag(C0014R.C0016id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new SimpleArrayMap<>();
                v.setTag(C0014R.C0016id.tag_unhandled_key_listeners, viewListeners);
            }
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0014R.C0016id.tag_unhandled_key_listeners);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList<>();
            v.setTag(C0014R.C0016id.tag_unhandled_key_listeners, viewListeners2);
        }
    ...
    public static void removeOnUnhandledKeyEventListener(View v, OnUnhandledKeyEventListenerCompat listener) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            SimpleArrayMap<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (SimpleArrayMap) v.getTag(C0014R.C0016id.tag_unhandled_key_listeners);
            if (viewListeners != null && (fwListener = (View.OnUnhandledKeyEventListener) viewListeners.get(listener)) != null) {
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0014R.C0016id.tag_screen_reader_focusable, Boolean.class, 28) {
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0014R.C0016id.tag_accessibility_pane_title, CharSequence.class, 8, 28) {
            /* access modifiers changed from: package-private */
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0014R.C0016id.tag_accessibility_heading, Boolean.class, 28) {
            /* access modifiers changed from: package-private */
            public Boolean frameworkGet(View view) {
    ...
    static abstract class AccessibilityViewProperty<T> {
        ...
        boolean shouldUpdate(T r2, T r3) {
            /*
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.view.ViewCompat.AccessibilityViewProperty.shouldUpdate(java.lang.Object, java.lang.Object):boolean");
        }
    ...
    static class UnhandledKeyEventManager {
        ...
        private boolean onUnhandledKeyEvent(View v, KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0014R.C0016id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                return false;
            }
