...
final class GradientColorInflaterCompat {
    ...
    /* JADX INFO: Multiple debug info for r2v6 float: [D('centerX' float), D('a' android.content.res.TypedArray)] */
    /* JADX INFO: Multiple debug info for r2v7 float: [D('centerX' float), D('a' android.content.res.TypedArray)] */
    ...
    private static android.support.p001v4.content.res.GradientColorInflaterCompat.ColorStops inflateChildElements(android.content.res.Resources r12, org.xmlpull.v1.XmlPullParser r13, android.util.AttributeSet r14, android.content.res.Resources.Theme r15) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            int r0 = r13.getDepth()
            r1 = 1
            int r0 = r0 + r1
        ...
        L_0x0028:
            ...
            goto L_0x0013
        L_0x0037:
            int[] r4 = android.support.compat.C0014R.styleable.GradientColorItem
            android.content.res.TypedArray r4 = android.support.p001v4.content.res.TypedArrayUtils.obtainAttributes(r12, r15, r14, r4)
            int r7 = android.support.compat.C0014R.styleable.GradientColorItem_android_color
            boolean r7 = r4.hasValue(r7)
            int r8 = android.support.compat.C0014R.styleable.GradientColorItem_android_offset
            boolean r8 = r4.hasValue(r8)
            if (r7 == 0) goto L_0x006d
            if (r8 == 0) goto L_0x006d
            int r9 = android.support.compat.C0014R.styleable.GradientColorItem_android_color
            r10 = 0
            int r9 = r4.getColor(r9, r10)
            int r10 = android.support.compat.C0014R.styleable.GradientColorItem_android_offset
            r11 = 0
