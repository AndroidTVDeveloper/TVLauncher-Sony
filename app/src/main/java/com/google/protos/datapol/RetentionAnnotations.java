...
public final class RetentionAnnotations {
    ...
    public static final class RetentionSpec extends GeneratedMessageLite<RetentionSpec, Builder> implements RetentionSpecOrBuilder {
        ...
        public static final RetentionSpec DEFAULT_INSTANCE;
        ...
        static {
            RetentionSpec defaultInstance = new RetentionSpec();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(RetentionSpec.class, defaultInstance);
        }
