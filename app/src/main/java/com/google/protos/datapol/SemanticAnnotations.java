...
public final class SemanticAnnotations {
    ...
    public static final class Qualifier extends GeneratedMessageLite<Qualifier, Builder> implements QualifierOrBuilder {
        ...
        public static final Qualifier DEFAULT_INSTANCE;
        ...
        static {
            Qualifier defaultInstance = new Qualifier();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(Qualifier.class, defaultInstance);
        }
    ...
    public static final class LocationQualifier extends GeneratedMessageLite<LocationQualifier, Builder> implements LocationQualifierOrBuilder {
        /* access modifiers changed from: private */
        public static final LocationQualifier DEFAULT_INSTANCE;
        ...
        static {
            LocationQualifier defaultInstance = new LocationQualifier();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(LocationQualifier.class, defaultInstance);
        }
    ...
    public static final class FieldDetails extends GeneratedMessageLite<FieldDetails, Builder> implements FieldDetailsOrBuilder {
        /* access modifiers changed from: private */
        public static final FieldDetails DEFAULT_INSTANCE;
        ...
        static {
            FieldDetails defaultInstance = new FieldDetails();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(FieldDetails.class, defaultInstance);
        }
    ...
    public static final class MessageDetails extends GeneratedMessageLite<MessageDetails, Builder> implements MessageDetailsOrBuilder {
        /* access modifiers changed from: private */
        public static final MessageDetails DEFAULT_INSTANCE;
        ...
        static {
            MessageDetails defaultInstance = new MessageDetails();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(MessageDetails.class, defaultInstance);
        }
