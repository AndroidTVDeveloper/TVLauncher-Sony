...
public final class PersistentFormat {
    ...
    public static final class BatterySnapshot extends GeneratedMessageLite<BatterySnapshot, Builder> implements BatterySnapshotOrBuilder {
        ...
        public static final BatterySnapshot DEFAULT_INSTANCE;
        ...
        static {
            BatterySnapshot defaultInstance = new BatterySnapshot();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(BatterySnapshot.class, defaultInstance);
        }
    ...
    public static final class PersistentMemorySamples extends GeneratedMessageLite<PersistentMemorySamples, Builder> implements PersistentMemorySamplesOrBuilder {
        /* access modifiers changed from: private */
        public static final PersistentMemorySamples DEFAULT_INSTANCE;
        ...
        static {
            PersistentMemorySamples defaultInstance = new PersistentMemorySamples();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(PersistentMemorySamples.class, defaultInstance);
        }
    ...
    public static final class MemorySample extends GeneratedMessageLite<MemorySample, Builder> implements MemorySampleOrBuilder {
        /* access modifiers changed from: private */
        public static final MemorySample DEFAULT_INSTANCE;
        ...
        static {
            MemorySample defaultInstance = new MemorySample();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(MemorySample.class, defaultInstance);
        }
