...
public class PrimesCrashConfigurations {
    ...
    @Deprecated
    public PrimesCrashConfigurations(boolean enabled2, CrashMetricExtensionProvider metricExtensionProvider2) {
    ...
    @Deprecated
    public PrimesCrashConfigurations(boolean enabled2, CrashMetricExtensionProvider metricExtensionProvider2, StackTraceTransmitter stackTraceTransmitter2, boolean sendStackTraces2) {
        this(enabled2, 100.0f, metricExtensionProvider2, stackTraceTransmitter2, sendStackTraces2, false);
    }

    private PrimesCrashConfigurations(boolean enabled2, float startupSamplePercentage2, CrashMetricExtensionProvider metricExtensionProvider2, StackTraceTransmitter stackTraceTransmitter2, boolean sendStackTraces2, boolean deferredInitLogging2) {
