...
public final class PrimesShutdown {
    ...
    private static final class GservicesDefaultShutdown extends Shutdown {
        ...
        public void init(Context context, Supplier<SharedPreferences> supplier, Supplier<ListeningScheduledExecutorService> executorServiceSupplier) {
    ...
    private static final class GServicesBroadcastReceiver extends BroadcastReceiver {
        ...
        GServicesBroadcastReceiver(Shutdown shutdown2, Supplier<Boolean> shutdownFlag2, Supplier<ListeningScheduledExecutorService> executorServiceSupplier2) {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            PrimesLog.m48d(PrimesShutdown.TAG, "BroadcastReceiver: action = %s", intent.getAction());
            if (this.shutdown.isShutdown()) {
                ...
                PrimesExecutors.handleFuture(executorService.submit((Runnable) new PrimesShutdown$GServicesBroadcastReceiver$$Lambda$0(this)));
            }
        }
