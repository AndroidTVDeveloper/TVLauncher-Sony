...
public final class TimerEvent {
    ...
    static /* synthetic */ class C11081 {
        ...
        static final /* synthetic */ int[] f128xd4658a1c = new int[TimerStatus.values().length];

        static {
            try {
                f128xd4658a1c[TimerStatus.UNKNOWN.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f128xd4658a1c[TimerStatus.SUCCESS.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f128xd4658a1c[TimerStatus.ERROR.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f128xd4658a1c[TimerStatus.CANCEL.ordinal()] = 4;
    ...
    public enum TimerStatus {
        ...
        public PrimesTraceOuterClass.EndStatus toProto() {
            int i = C11081.f128xd4658a1c[ordinal()];
            if (i == 1) {
