...
final class FrameMetricService extends AbstractMetricService implements AppLifecycleListener.OnAppToBackground, PrimesStartupListener {
    ...
    static FrameMetricService createService(MetricTransmitter transmitter, Application application, Supplier<MetricStamper> metricStamperSupplier, Supplier<ListeningScheduledExecutorService> executorServiceSupplier, FrameTimeMeasurementFactory frameTimeMeasurementFactory2, PrimesJankConfigurations configuration) {
    ...
    FrameMetricService(MetricTransmitter transmitter, Application application, Supplier<MetricStamper> metricStamperSupplier, Supplier<ListeningScheduledExecutorService> executorServiceSupplier, boolean monitorActivities2, int maxSampleRate, FrameTimeMeasurementFactory frameTimeMeasurementFactory2, final JankMetricExtensionProvider metricExtensionProvider2) {
    ...
    public void startMeasurement(java.lang.String r6) {
        /*
            ...
            com.google.android.libraries.performance.primes.PrimesLog.m56w(r1, r4, r3)     // Catch:{ all -> 0x0058 }
        ...
        L_0x0031:
            ...
            com.google.android.libraries.performance.primes.PrimesLog.m48d(r1, r3, r2)     // Catch:{ all -> 0x0058 }
    ...
    public void stopMeasurement(String eventName, boolean isConstEventName, @Nullable ExtensionMetric.MetricExtension metricExtension) {
        ...
        if (measurement == null) {
            PrimesLog.m56w(TAG, "Measurement not found: %s", eventName);
