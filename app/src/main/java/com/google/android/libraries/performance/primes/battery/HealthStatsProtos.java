...
final class HealthStatsProtos {
    ...
    private static abstract class ProtoStatsOps<S, P extends MessageLite> {
        ...
        /* access modifiers changed from: package-private */
        public abstract P subtract(P p, P p2);
    ...
    private static class CounterOps extends ProtoStatsOps<Long, BatteryMetric.Counter> {
        ...
        /* access modifiers changed from: package-private */
        public BatteryMetric.Counter subtract(BatteryMetric.Counter a, BatteryMetric.Counter b) {
    ...
    private static final class TimerOps extends ProtoStatsOps<TimerStat, BatteryMetric.Timer> {
        ...
        /* access modifiers changed from: package-private */
        public BatteryMetric.Timer subtract(BatteryMetric.Timer a, BatteryMetric.Timer b) {
            return HealthStatsProtos.subtract(a, b);
        }
    ...
    private static final class PackageHealthProtoOps extends ProtoStatsOps<HealthStats, BatteryMetric.PackageHealthProto> {
        ...
        /* access modifiers changed from: package-private */
        public BatteryMetric.PackageHealthProto subtract(BatteryMetric.PackageHealthProto a, BatteryMetric.PackageHealthProto b) {
            return HealthStatsProtos.subtract(a, b);
        }
    ...
    private static final class ProcessHealthProtoOps extends ProtoStatsOps<HealthStats, BatteryMetric.ProcessHealthProto> {
        ...
        /* access modifiers changed from: package-private */
        public BatteryMetric.ProcessHealthProto subtract(BatteryMetric.ProcessHealthProto a, BatteryMetric.ProcessHealthProto b) {
            return HealthStatsProtos.subtract(a, b);
        }
    ...
    private static final class ServiceHealthProtoOps extends ProtoStatsOps<HealthStats, BatteryMetric.ServiceHealthProto> {
        ...
        /* access modifiers changed from: package-private */
        public BatteryMetric.ServiceHealthProto subtract(BatteryMetric.ServiceHealthProto a, BatteryMetric.ServiceHealthProto b) {
            return HealthStatsProtos.subtract(a, b);
        }
    ...
    /* access modifiers changed from: private */
    public static BatteryMetric.Timer timer(String name, TimerStat timer) {
    ...
    static BatteryMetric.Timer subtract(BatteryMetric.Timer a, BatteryMetric.Timer b) {
        if (a == null || b == null) {
            return a;
        }
    ...
    static BatteryMetric.Counter subtract(BatteryMetric.Counter a, BatteryMetric.Counter b) {
        if (a == null || b == null) {
            return a;
        }
        if (!a.hasCount()) {
    ...
    static BatteryMetric.ProcessHealthProto subtract(BatteryMetric.ProcessHealthProto a, BatteryMetric.ProcessHealthProto b) {
        if (a == null || b == null) {
            return a;
        }
        BatteryMetric.ProcessHealthProto.Builder result = BatteryMetric.ProcessHealthProto.newBuilder();
    ...
    static BatteryMetric.PackageHealthProto subtract(BatteryMetric.PackageHealthProto a, BatteryMetric.PackageHealthProto b) {
        if (a == null || b == null) {
            return a;
        }
        BatteryMetric.PackageHealthProto.Builder result = BatteryMetric.PackageHealthProto.newBuilder();
    ...
    static BatteryMetric.ServiceHealthProto subtract(BatteryMetric.ServiceHealthProto a, BatteryMetric.ServiceHealthProto b) {
        int value;
        int value2;
        if (a == null || b == null) {
            return a;
    ...
    static BatteryMetric.UidHealthProto convert(HealthStats stats) {
    ...
    static BatteryMetric.UidHealthProto subtract(BatteryMetric.UidHealthProto a, BatteryMetric.UidHealthProto b) {
        if (a == null || b == null) {
            return a;
        }
        BatteryMetric.UidHealthProto.Builder result = BatteryMetric.UidHealthProto.newBuilder();
    ...
    private static long getMeasurement(HealthStats stats, int key) {
    ...
    private static BatteryMetric.Timer getTimer(HealthStats stats, int key) {
    ...
    private static List<BatteryMetric.Timer> getTimers(HealthStats stats, int key) {
    ...
    private static Map<String, Long> getMeasurementsMap(HealthStats stats, int key) {
        return (stats == null || !stats.hasMeasurements(key)) ? Collections.emptyMap() : stats.getMeasurements(key);
    }

    private static Map<String, HealthStats> getStatsMap(HealthStats stats, int key) {
