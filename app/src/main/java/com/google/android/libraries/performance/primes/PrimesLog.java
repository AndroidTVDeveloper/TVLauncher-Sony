...
public final class PrimesLog {
    ...
    public static <T> void toc(int priority, String tag, String msg, T... args) {
        try {
            ...
            m47d(PRIMES_TAG, "toc failed %s: tag:%s msg:%s]", re, threadInfoString(), tag, message(msg, args));
        }
    }
    ...
    private static <T> void log(int priority, String tag, Throwable ex, String msg, T... args) {
        ...
        if (priority == 2) {
            ...
            m56w("PrimesLog", "unexpected priority: %d for log %s: %s", Integer.valueOf(priority), tag, message(msg, args));
        } else {
    ...
    /* renamed from: v */
    public static <T> void m54v(String tag, String msg, T... args) {
        log(2, tag, msg, args);
    }

    /* renamed from: v */
    public static <T> void m53v(String tag, String msg, Throwable ex, T... args) {
    ...
    /* renamed from: d */
    public static <T> void m48d(String tag, String msg, T... args) {
        log(3, tag, msg, args);
    }

    /* renamed from: d */
    public static <T> void m47d(String tag, String msg, Throwable ex, T... args) {
    ...
    /* renamed from: i */
    public static <T> void m52i(String tag, String msg, T... args) {
        log(4, tag, msg, args);
    }

    /* renamed from: i */
    public static <T> void m51i(String tag, String msg, Throwable ex, T... args) {
    ...
    /* renamed from: w */
    public static <T> void m56w(String tag, String msg, T... args) {
        log(5, tag, msg, args);
    }

    /* renamed from: w */
    public static <T> void m55w(String tag, String msg, Throwable ex, T... args) {
    ...
    /* renamed from: e */
    public static <T> void m50e(String tag, String msg, T... args) {
        log(6, tag, msg, args);
    }

    /* renamed from: e */
    public static <T> void m49e(String tag, String msg, Throwable ex, T... args) {
