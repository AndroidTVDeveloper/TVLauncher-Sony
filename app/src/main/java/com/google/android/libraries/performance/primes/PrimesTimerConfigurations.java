...
public class PrimesTimerConfigurations {
    ...
    @Deprecated
    public PrimesTimerConfigurations(boolean enabled2, int sampleRatePerSecond2, PrimesPerEventConfigurationFlags perEventConfigFlags2) {
    ...
    public static final class Builder {
        ...
        public Builder setPerEventConfiguration(PrimesPerEventConfigurationFlags perEventConfigFlags2) {
            this.perEventConfigFlags = Optional.m82of(perEventConfigFlags2);
            return this;
        }
