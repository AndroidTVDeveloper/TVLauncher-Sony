...
public abstract class HashedNamesTransmitter implements MetricTransmitter {
    static final MetricNameAccess<BatteryMetric.BatteryStatsDiff.Builder> BATTERY_METRIC_NAME_ACCESS = new MetricNameAccess<BatteryMetric.BatteryStatsDiff.Builder>() {
        ...
        public void setCustomName(BatteryMetric.BatteryStatsDiff.Builder message, String name) {
            if (name != null) {
        ...
        public void setHashedName(BatteryMetric.BatteryStatsDiff.Builder message, Long hash) {
            if (hash != null) {
    ...
    static final MetricNameAccess<SystemHealthProto.SystemHealthMetric.Builder> SHM_METRIC_NAME_ACCESS = new MetricNameAccess<SystemHealthProto.SystemHealthMetric.Builder>() {
        ...
        public void setCustomName(SystemHealthProto.SystemHealthMetric.Builder message, String name) {
            if (name != null) {
        ...
        public void setHashedName(SystemHealthProto.SystemHealthMetric.Builder message, Long hash) {
            if (hash != null) {
    ...
    static final MetricNameAccess<PrimesTraceOuterClass.Span.Builder> SPAN_METRIC_NAME_ACCESS = new MetricNameAccess<PrimesTraceOuterClass.Span.Builder>() {
        ...
        public void setCustomName(PrimesTraceOuterClass.Span.Builder messageBuilder, String name) {
            if (name == null) {
        ...
        public void setHashedName(PrimesTraceOuterClass.Span.Builder messageBuilder, Long hash) {
            if (hash == null) {
    ...
    public void send(SystemHealthProto.SystemHealthMetric message) {
        if (PrimesLog.vLoggable(TAG)) {
            PrimesLog.m54v(TAG, "unhashed: %s", message);
        }
