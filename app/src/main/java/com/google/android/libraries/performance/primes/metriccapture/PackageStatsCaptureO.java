...
final class PackageStatsCaptureO {
    ...
    static android.content.pm.PackageStats getPackageStats(android.content.Context r13) {
        /*
            ...
            com.google.android.libraries.performance.primes.PrimesLog.m50e(r3, r4, r2)
            return r1
        L_0x0019:
        ...
        L_0x0068:
            ...
            com.google.android.libraries.performance.primes.PrimesLog.m49e(r3, r11, r10, r12)     // Catch:{ RuntimeException -> 0x0074, Error -> 0x0072 }
        L_0x0070:
            goto L_0x0032
        L_0x0071:
            return r6
        ...
        L_0x0075:
            ...
            com.google.android.libraries.performance.primes.PrimesLog.m55w(r3, r5, r4, r2)
            return r1
        */
    ...
    private static UUID getUuid(StorageVolume storageVolume) {
        ...
        try {
            PrimesLog.m48d(TAG, "UUID for %s", uuidStr);
            return uuidStr == null ? StorageManager.UUID_DEFAULT : UUID.fromString(uuidStr);
        } catch (IllegalArgumentException e) {
            PrimesLog.m50e(TAG, "Invalid UUID format: '%s'", uuidStr);
            return null;
        }
    }
