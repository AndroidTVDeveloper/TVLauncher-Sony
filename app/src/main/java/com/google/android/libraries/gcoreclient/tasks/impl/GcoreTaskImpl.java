...
public final class GcoreTaskImpl<TInput, TResult> implements GcoreTask<TResult> {
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T> com.google.android.libraries.gcoreclient.tasks.GcoreTask<T> wrap(com.google.android.gms.tasks.Task<T> r1, com.google.android.libraries.gcoreclient.common.api.support.GcoreExceptionMapper r2) {
        /*
            com.google.common.base.Function r0 = com.google.common.base.Functions.identity()
    ...
    public static <T, V> GcoreTask<V> wrap(Task<T> task2, Function<T, V> wrapperFunction2, GcoreExceptionMapper gcoreExceptionMapper2) {
        return new GcoreTaskImpl(task2, wrapperFunction2, gcoreExceptionMapper2);
    }

    private GcoreTaskImpl(Task<TInput> task2, Function<TInput, TResult> wrapperFunction2, GcoreExceptionMapper gcoreExceptionMapper2) {
