...
final class PrimesStartupTraceGenerator {
    ...
    private static List<SpanEvent> getChildSpans(PrimesStartupMeasure startupMeasure, long mainThreadId) {
        ...
        if (isColdStartup) {
            ...
            String valueOf2 = SPAN_ACTIVITY_ONCREATE_SUFFIX;
            SpanEvent spanActivityOnCreate = SpanEvent.newSpan(primesToken, valueOf2.length() != 0 ? valueOf.concat(valueOf2) : valueOf, SpanEvent.EventNameType.CONSTANT, startupMeasure.getAppOnCreateAt(), startupActivityInfos[0].onActivityCreatedAt, mainThreadId, SpanEvent.SpanType.CHILD_SPAN);
            ...
            if (startupMeasure.getFirstOnActivityInitAt() > 0) {
                ...
                String valueOf4 = SPAN_ACTIVITY_INIT_SUFFIX;
                spanActivityOnCreate.addChildSpan(primesToken2, SpanEvent.newSpan(primesToken3, valueOf4.length() != 0 ? valueOf3.concat(valueOf4) : valueOf3, SpanEvent.EventNameType.CONSTANT, startupMeasure.getAppOnCreateAt(), startupMeasure.getFirstOnActivityInitAt(), mainThreadId, SpanEvent.SpanType.CHILD_SPAN));
            }
        } else {
            PrimesToken primesToken4 = PrimesToken.PRIMES_TOKEN;
            String valueOf5 = String.valueOf(startupActivityInfos[0].activityName);
            String valueOf6 = SPAN_ACTIVITY_ONCREATE_SUFFIX;
            spanEvents.add(SpanEvent.newSpan(primesToken4, valueOf6.length() != 0 ? valueOf5.concat(valueOf6) : valueOf5, SpanEvent.EventNameType.CONSTANT, startupMeasure.getFirstOnActivityInitAt(), startupActivityInfos[0].onActivityCreatedAt, mainThreadId, SpanEvent.SpanType.CHILD_SPAN));
        }
        ...
        for (int index = 1; index < startupActivityInfos.length; index++) {
            ...
            String valueOf8 = SPAN_ACTIVITY_ONCREATE_SUFFIX;
            spanEvents.add(SpanEvent.newSpan(primesToken5, valueOf8.length() != 0 ? valueOf7.concat(valueOf8) : valueOf7, SpanEvent.EventNameType.CONSTANT, startTimeMs, endTimeMs, mainThreadId, SpanEvent.SpanType.CHILD_SPAN));
        ...
        String valueOf10 = SPAN_ACTIVITY_ONSTART_SUFFIX;
        spanEvents.add(SpanEvent.newSpan(primesToken6, valueOf10.length() != 0 ? valueOf9.concat(valueOf10) : valueOf9, SpanEvent.EventNameType.CONSTANT, startTimeMs2, startupMeasure.getFirstOnActivityStartedAt(), mainThreadId, SpanEvent.SpanType.CHILD_SPAN));
        PrimesToken primesToken7 = PrimesToken.PRIMES_TOKEN;
        String valueOf11 = String.valueOf(drawActivityName);
        String valueOf12 = SPAN_ACTIVITY_ONRESUME_SUFFIX;
        spanEvents.add(SpanEvent.newSpan(primesToken7, valueOf12.length() != 0 ? valueOf11.concat(valueOf12) : valueOf11, SpanEvent.EventNameType.CONSTANT, startupMeasure.getFirstOnActivityStartedAt(), startupMeasure.getFirstOnActivityResumedAt(), mainThreadId, SpanEvent.SpanType.CHILD_SPAN));
        PrimesToken primesToken8 = PrimesToken.PRIMES_TOKEN;
        String valueOf13 = String.valueOf(drawActivityName);
        String valueOf14 = SPAN_ACTIVITY_DRAW_SUFFIX;
        spanEvents.add(SpanEvent.newSpan(primesToken8, valueOf14.length() != 0 ? valueOf13.concat(valueOf14) : valueOf13, SpanEvent.EventNameType.CONSTANT, startupMeasure.getFirstOnActivityResumedAt(), startupMeasure.getFirstDrawnAt(), mainThreadId, SpanEvent.SpanType.CHILD_SPAN));
        return spanEvents;
    }
