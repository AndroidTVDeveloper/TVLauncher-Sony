...
public final class MetricStamper {
    ...
    MetricStamper(String appPackage, String shortProcessName2, String versionName2, SystemHealthProto.ApplicationInfo.HardwareVariant hardwareVariant2, Long primesVersion2, DataPartitionSize dataPartitionSize2, Supplier<NoPiiString> componentNameSupplier2) {
    ...
    public static MetricStamper createMetricStamper(Context applicationContext, Supplier<NoPiiString> componentNameSupplier2) {
        String versionName2;
        ...
        try {
            ...
            PrimesLog.m56w(TAG, "Failed to get PackageInfo for: %s", applicationPackage2);
            versionName2 = null;
        }
