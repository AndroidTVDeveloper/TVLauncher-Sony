...
final class StrictModeService extends AbstractMetricService implements PrimesStartupListener {
    ...
    protected StrictModeService(MetricTransmitter transmitter, Application application, Supplier<MetricStamper> metricStamperSupplier, Supplier<ListeningScheduledExecutorService> executorServiceSupplier) {
    ...
    public final /* synthetic */ void lambda$onPrimesInitialize$0$StrictModeService() {
        StrictMode.setThreadPolicy(new StrictMode.ThreadPolicy.Builder().detectAll().penaltyListener(getListeningScheduledExecutorService(), this.onThreadViolation).build());
    }
