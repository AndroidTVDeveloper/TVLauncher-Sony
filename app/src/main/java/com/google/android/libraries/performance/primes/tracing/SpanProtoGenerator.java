...
public final class SpanProtoGenerator {
    ...
    private static PrimesTraceOuterClass.Span createSpanProto(SpanEvent spanEvent, long id, long parentId) {
        ...
        int i = C11271.f131x6154420e[spanEvent.spanType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C11271 {
        ...
        static final /* synthetic */ int[] f131x6154420e = new int[SpanEvent.SpanType.values().length];

        static {
            try {
                f131x6154420e[SpanEvent.SpanType.ROOT_SPAN.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f131x6154420e[SpanEvent.SpanType.TIMER_SPAN.ordinal()] = 2;
