...
public final class NetworkEvent {
    ...
    public static NetworkEvent forConstantRpcPath(String domainPath2, NoPiiString rpcPath) {
    ...
    private NetworkEvent(String domainPath2, String requestPath2, boolean isConstantRpcPath2) {
