...
public final class PrimesThreadsConfigurations {
    ...
    private PrimesThreadsConfigurations(ListeningScheduledExecutorService primesExecutorService2, int primesInitializationPriority2, int primesMetricExecutorPriority2, int primesMetricExecutorPoolSize2, InitAfterResumedFlag initAfterResumed2, ActivityResumedCallback activityResumedCallback2, boolean enableEarlyTimers2) {
    ...
    public static final class Builder {
        ...
        public Builder setPrimesExecutorService(CustomExecutorToken token, ListeningScheduledExecutorService service) {
            if (token != null) {
