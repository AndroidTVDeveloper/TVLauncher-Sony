...
public class PrimesNetworkConfigurations {
    ...
    @Deprecated
    public PrimesNetworkConfigurations(boolean enabled2, UrlSanitizer urlSanitizer2) {
        this(enabled2, urlSanitizer2, false, 50, Optional.absent());
    }

    @Deprecated
    public PrimesNetworkConfigurations(boolean enabled2, UrlSanitizer urlSanitizer2, int batchSize2) {
        this(enabled2, urlSanitizer2, false, batchSize2, Optional.absent());
    }

    private PrimesNetworkConfigurations(boolean enabled2, UrlSanitizer urlSanitizer2, boolean enableUrlAutoSanitization2, int batchSize2, Optional<NetworkMetricExtensionProvider> metricExtensionProvider2) {
