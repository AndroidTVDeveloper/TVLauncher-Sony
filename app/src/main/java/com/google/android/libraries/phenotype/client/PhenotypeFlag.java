...
public abstract class PhenotypeFlag<T> {
    ...
    private T getInternal() {
        ...
        if (context != null) {
            String fileOverride = hermeticFileOverrides.get().get(this.factory.contentProviderUri, this.factory.sharedPrefsName, this.factory.phenotypePrefix, this.name);
            if (fileOverride != null) {
                return convertValue(fileOverride);
            }
    ...
    private T loadValueFromGservices() {
        ...
        if ((this.factory.allowGservicesFn == null || this.factory.allowGservicesFn.apply(context).booleanValue()) && (value = GservicesLoader.getLoader(context).getFlag(getGservicesFlagName())) != null) {
            return convertValue(value);
        }
        return null;
    }
