...
public final class Binder {
    ...
    public void attachContext(Context context2) {
        Preconditions.checkState(this.context == null, "Binder is already attached to context %s, cannot use %s.", this.context, context2);
        this.context = context2;
        if (this.tag == null) {
            this.tag = context2.getClass().getName();
        }
    ...
    /* JADX INFO: Multiple debug info for r3v0 boolean: [D('instance' T), D('isAlreadyInternallyBinding' boolean)] */
