...
public class Primes {
    ...
    @Deprecated
    public void stopTimer(TimerEvent event, String customEventName) {
        this.primesApi.stopTimer(event, customEventName, false, TimerEvent.TimerStatus.UNKNOWN);
    }

    @Deprecated
    public synchronized void stopTimer(TimerEvent event, String customEventName, ExtensionMetric.MetricExtension metricExtension) {
        this.primesApi.stopTimer(event, customEventName, false, metricExtension, TimerEvent.TimerStatus.UNKNOWN);
    }

    public void stopTimer(TimerEvent event, NoPiiString eventName) {
        stopTimer(event, eventName, TimerEvent.TimerStatus.UNKNOWN);
    }

    public void stopTimer(TimerEvent event, NoPiiString eventName, TimerEvent.TimerStatus timerStatus) {
        this.primesApi.stopTimer(event, toString(eventName), true, timerStatus);
    }

    public synchronized void stopTimer(TimerEvent event, NoPiiString eventName, ExtensionMetric.MetricExtension metricExtension, TimerEvent.TimerStatus timerStatus) {
        this.primesApi.stopTimer(event, toString(eventName), true, metricExtension, timerStatus);
    }

    public synchronized void stopTimer(TimerEvent event, NoPiiString eventName, ExtensionMetric.MetricExtension metricExtension) {
    ...
    public void stopJankRecorder(NoPiiString eventName, ExtensionMetric.MetricExtension metricExtension) {
