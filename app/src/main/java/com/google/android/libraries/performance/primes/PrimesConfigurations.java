...
public abstract class PrimesConfigurations {
    ...
    public static final class Builder {
        ...
        public Builder setMemoryConfigurations(PrimesMemoryConfigurations memoryConfigs2) {
            this.memoryConfigs = Optional.fromNullable(memoryConfigs2);
            return this;
        }

        public Builder setGlobalConfigurations(PrimesGlobalConfigurations globalConfigs2) {
            this.globalConfigs = Optional.fromNullable(globalConfigs2);
            return this;
        }

        public Builder setTimerConfigurations(PrimesTimerConfigurations timerConfigs2) {
            this.timerConfigs = Optional.fromNullable(timerConfigs2);
            return this;
        }

        public Builder setCrashConfigurations(PrimesCrashConfigurations crashConfigs2) {
            this.crashConfigs = Optional.fromNullable(crashConfigs2);
            return this;
        }

        public Builder setNetworkConfigurations(PrimesNetworkConfigurations networkConfigs2) {
            this.networkConfigs = Optional.fromNullable(networkConfigs2);
            return this;
        }

        public Builder setPackageConfigurations(PrimesPackageConfigurations packageConfigs2) {
            this.packageConfigs = Optional.fromNullable(packageConfigs2);
            return this;
        }

        public Builder setJankConfigurations(PrimesJankConfigurations jankConfigs2) {
            this.jankConfigs = Optional.fromNullable(jankConfigs2);
            return this;
        }

        @Deprecated
        public Builder setTraceConfigurations(PrimesTikTokTraceConfigurations tiktokTraceConfigs2) {
            this.tiktokTraceConfigs = Optional.fromNullable(tiktokTraceConfigs2);
            return this;
        }

        public Builder setTikTokTraceConfigurations(PrimesTikTokTraceConfigurations tiktokTraceConfigs2) {
            this.tiktokTraceConfigs = Optional.fromNullable(tiktokTraceConfigs2);
            return this;
        }

        public Builder setPrimesTraceConfigurations(PrimesTraceConfigurations primesTraceConfigs2) {
            this.primesTraceConfigs = Optional.fromNullable(primesTraceConfigs2);
            return this;
        }

        public Builder setBatteryConfigurations(PrimesBatteryConfigurations batteryConfigs2) {
            this.batteryConfigs = Optional.fromNullable(batteryConfigs2);
            return this;
        }

        public Builder setMemoryLeakConfigurations(PrimesMemoryLeakConfigurations memoryLeakConfigs2) {
            this.memoryLeakConfigs = Optional.fromNullable(memoryLeakConfigs2);
            return this;
        }

        public Builder setExperimentalConfigurations(PrimesExperimentalConfigurations experimentalConfigs2) {
            this.experimentalConfigs = Optional.fromNullable(experimentalConfigs2);
            return this;
        }

        public Builder setCpuConfigurations(PrimesCpuConfigurations cpuConfigs2) {
