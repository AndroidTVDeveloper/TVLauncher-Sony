...
public class HomeFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>, LaunchItemsManager.SearchPackageChangeListener, OemConfiguration.OemConfigurationPackageChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.idlePeriod = getResources().getInteger(C1167R.integer.idle_period);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(C1167R.layout.fragment_home, container, false);
    }

    public void onViewCreated(View view, Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        VerticalGridView homeRowList = (VerticalGridView) view.findViewById(C1167R.C1170id.home_row_list);
        ...
        if (!OemUtils.isOperatorTierDevice(view.getContext()) || backgroundUri == null) {
            this.homeController.setBackgroundController(new HomeBackgroundController(homeRowList));
        } else {
            new BitmapHomeBackgroundController(backgroundUri, homeRowList.getContext()).loadInto(homeRowList);
        }
