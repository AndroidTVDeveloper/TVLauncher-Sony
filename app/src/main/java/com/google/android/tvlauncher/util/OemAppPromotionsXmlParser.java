...
class OemAppPromotionsXmlParser {
    ...
    private static OemAppPromotionsXmlParser oemAppPromotionsXmlParser;

    OemAppPromotionsXmlParser() {
    }

    static class PromotionsData {
        private HashSet<OemPromotionApp> dedupeCheckSet = new HashSet<>();
        ...
        public void add(OemPromotionApp promotion) {
            if (!this.dedupeCheckSet.contains(promotion)) {
                this.promotions.add(promotion);
                this.dedupeCheckSet.add(promotion);
            }
        }
    ...
    static OemAppPromotionsXmlParser getInstance(Context context) {
        if (oemAppPromotionsXmlParser == null) {
            synchronized (OemAppPromotionsXmlParser.class) {
                if (oemAppPromotionsXmlParser == null) {
                    initializeCategoryMap(context);
                    oemAppPromotionsXmlParser = new OemAppPromotionsXmlParser();
                }
            }
        }
        return oemAppPromotionsXmlParser;
    }

    /* access modifiers changed from: package-private */
    public PromotionsData parse(InputStream inputStream) {
    ...
    private static boolean parseTag(org.xmlpull.v1.XmlPullParser r24, com.google.android.tvlauncher.util.OemAppPromotionsXmlParser.PromotionsData r25, com.google.android.tvlauncher.util.OemAppPromotionsXmlParser.ParentPromotion r26) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x00a4:
            ...
            java.util.Map<java.lang.String, java.lang.String> r5 = com.google.android.tvlauncher.util.OemAppPromotionsXmlParser.categoryMap
    ...
    private static void initializeCategoryMap(Context context) {
        categoryMap.put(CATEGORY_KEY_ART_AND_DESIGN, context.getString(C1167R.string.category_art_and_design));
        categoryMap.put(CATEGORY_KEY_AUTO_AND_VEHICLES, context.getString(C1167R.string.category_auto_and_vehicles));
        categoryMap.put(CATEGORY_KEY_BEAUTY, context.getString(C1167R.string.category_beauty));
        categoryMap.put(CATEGORY_KEY_BOOKS_AND_REFERENCE, context.getString(C1167R.string.category_books_and_reference));
        categoryMap.put(CATEGORY_KEY_BUSINESS, context.getString(C1167R.string.category_business));
        categoryMap.put(CATEGORY_KEY_COMICS, context.getString(C1167R.string.category_comics));
        categoryMap.put(CATEGORY_KEY_COMMUNICATION, context.getString(C1167R.string.category_communication));
        categoryMap.put(CATEGORY_KEY_DATING, context.getString(C1167R.string.category_dating));
        categoryMap.put(CATEGORY_KEY_EDUCATION, context.getString(C1167R.string.category_education));
        categoryMap.put(CATEGORY_KEY_ENTERTAINMENT, context.getString(C1167R.string.category_entertainment));
        categoryMap.put(CATEGORY_KEY_EVENTS, context.getString(C1167R.string.category_events));
        categoryMap.put(CATEGORY_KEY_FINANCE, context.getString(C1167R.string.category_finance));
        categoryMap.put(CATEGORY_KEY_FOOD_AND_DRINK, context.getString(C1167R.string.category_food_and_drink));
        categoryMap.put(CATEGORY_KEY_HEALTH_AND_FITNESS, context.getString(C1167R.string.category_health_and_fitness));
        categoryMap.put(CATEGORY_KEY_HOUSE_AND_HOME, context.getString(C1167R.string.category_house_and_home));
        categoryMap.put(CATEGORY_KEY_LIFESTYLE, context.getString(C1167R.string.category_lifestyle));
        categoryMap.put(CATEGORY_KEY_MAPS_AND_NAVIGATION, context.getString(C1167R.string.category_maps_and_navigation));
        categoryMap.put(CATEGORY_KEY_MEDICAL, context.getString(C1167R.string.category_medical));
        categoryMap.put(CATEGORY_KEY_MUSIC_AND_AUDIO, context.getString(C1167R.string.category_music_and_audio));
        categoryMap.put(CATEGORY_KEY_NEWS_AND_MAGAZINES, context.getString(C1167R.string.category_news_and_magazines));
        categoryMap.put(CATEGORY_KEY_PARENTING, context.getString(C1167R.string.category_parenting));
        categoryMap.put(CATEGORY_KEY_PERSONALIZATION, context.getString(C1167R.string.category_personalization));
        categoryMap.put(CATEGORY_KEY_PHOTOGRAPHY, context.getString(C1167R.string.category_photography));
        categoryMap.put(CATEGORY_KEY_PRODUCTIVITY, context.getString(C1167R.string.category_productivity));
        categoryMap.put(CATEGORY_KEY_SHOPPING, context.getString(C1167R.string.category_shopping));
        categoryMap.put("social", context.getString(C1167R.string.category_social));
        categoryMap.put(CATEGORY_KEY_SPORTS, context.getString(C1167R.string.category_sports));
        categoryMap.put(CATEGORY_KEY_TOOLS, context.getString(C1167R.string.category_tools));
        categoryMap.put(CATEGORY_KEY_TRAVEL_AND_LOCAL, context.getString(C1167R.string.category_travel_and_local));
        categoryMap.put(CATEGORY_KEY_VIDEO_PLAYERS_AND_EDITORS, context.getString(C1167R.string.category_video_players_and_editors));
        categoryMap.put(CATEGORY_KEY_WEATHER, context.getString(C1167R.string.category_weather));
        categoryMap.put(CATEGORY_KEY_LIBRARIES_AND_DEMO, context.getString(C1167R.string.category_libraries_and_demo));
        categoryMap.put(CATEGORY_KEY_ARCADE_GAMES, context.getString(C1167R.string.category_arcade_games));
        categoryMap.put(CATEGORY_KEY_PUZZLE_GAMES, context.getString(C1167R.string.category_puzzle_games));
        categoryMap.put(CATEGORY_KEY_CARD_GAMES, context.getString(C1167R.string.category_card_games));
        categoryMap.put(CATEGORY_KEY_CASUAL_GAMES, context.getString(C1167R.string.category_casual_games));
        categoryMap.put(CATEGORY_KEY_RACING_GAMES, context.getString(C1167R.string.category_racing_games));
        categoryMap.put(CATEGORY_KEY_SPORT_GAMES, context.getString(C1167R.string.category_sport_games));
        categoryMap.put(CATEGORY_KEY_ACTION_GAMES, context.getString(C1167R.string.category_action_games));
        categoryMap.put(CATEGORY_KEY_ADVENTURE_GAMES, context.getString(C1167R.string.category_adventure_games));
        categoryMap.put(CATEGORY_KEY_BOARD_GAMES, context.getString(C1167R.string.category_board_games));
        categoryMap.put(CATEGORY_KEY_CASINO_GAMES, context.getString(C1167R.string.category_casino_games));
        categoryMap.put(CATEGORY_KEY_EDUCATIONAL_GAMES, context.getString(C1167R.string.category_educational_games));
        categoryMap.put(CATEGORY_KEY_MUSIC_GAMES, context.getString(C1167R.string.category_music_games));
        categoryMap.put(CATEGORY_KEY_ROLE_PLAYING_GAMES, context.getString(C1167R.string.category_role_playing_games));
        categoryMap.put(CATEGORY_KEY_SIMULATION_GAMES, context.getString(C1167R.string.category_simulation_games));
        categoryMap.put(CATEGORY_KEY_STRATEGY_GAMES, context.getString(C1167R.string.category_strategy_games));
        categoryMap.put(CATEGORY_KEY_TRIVIA_GAMES, context.getString(C1167R.string.category_trivia_games));
        categoryMap.put(CATEGORY_KEY_WORD_GAMES, context.getString(C1167R.string.category_word_games));
    }
}
