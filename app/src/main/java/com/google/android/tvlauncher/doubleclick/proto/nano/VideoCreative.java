...
public interface VideoCreative {
    ...
    final class VastXml extends MessageNano {
        ...
        public VastTracking videoViewableImpression;
        ...
        public VastXml clear() {
            ...
            this.sequence = 0;
            this.videoViewableImpression = null;
            this.cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (!this.f152id.equals("")) {
                output.writeString(18, this.f152id);
            }
            if (!this.adId.equals("")) {
            ...
            VastTracking vastTracking = this.videoViewableImpression;
            if (vastTracking != null) {
                output.writeMessage(23, vastTracking);
            }
        ...
        public int computeSerializedSize() {
            ...
            if (!this.f152id.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(18, this.f152id);
            }
            if (!this.adId.equals("")) {
            ...
            int i12 = this.sequence;
            if (i12 != 0) {
                size += CodedOutputByteBufferNano.computeInt32Size(22, i12);
            }
            VastTracking vastTracking = this.videoViewableImpression;
            if (vastTracking != null) {
                return size + CodedOutputByteBufferNano.computeMessageSize(23, vastTracking);
            }
            return size;
        }
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 138:
                        ...
                        break;
                    case ClientAnalytics.LogRequest.LogSource.ON_THE_GO_COUNTERS_VALUE:
                        this.f152id = input.readString();
                        break;
                    case ClientAnalytics.LogRequest.LogSource.YT_MAIN_APP_ANDROID_PRIMES_VALUE:
                        this.adId = input.readString();
                        break;
                    case ClientAnalytics.LogRequest.LogSource.JAM_KIOSK_ANDROID_PRIMES_VALUE:
                        this.vastVersion = input.readInt32();
                        break;
                    case ClientAnalytics.LogRequest.LogSource.SLIDES_ANDROID_PRIMES_VALUE:
                        this.customSkipEventExists = input.readBool();
                        break;
                    case ClientAnalytics.LogRequest.LogSource.ANDROID_DIALER_VALUE:
                        this.sequence = input.readInt32();
                        break;
                    case ClientAnalytics.LogRequest.LogSource.FUSE_VALUE:
                        if (this.videoViewableImpression == null) {
                            this.videoViewableImpression = new VastTracking();
                        }
                        input.readMessage(this.videoViewableImpression);
                        break;
                    default:
    ...
    final class VastImpression extends MessageNano {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            if (!this.f151id.equals("")) {
                output.writeString(1, this.f151id);
            }
            if (!this.url.equals("")) {
        ...
        public int computeSerializedSize() {
            int size = super.computeSerializedSize();
            if (!this.f151id.equals("")) {
                size += CodedOutputByteBufferNano.computeStringSize(1, this.f151id);
            }
            if (!this.url.equals("")) {
