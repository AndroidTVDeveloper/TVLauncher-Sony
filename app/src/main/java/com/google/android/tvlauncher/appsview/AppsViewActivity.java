...
public class AppsViewActivity extends BlockForDataLauncherActivity implements AppsViewFragment.OnForceFinishAnimationListener {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      ...
      ClspMth{android.content.Intent.putExtra(java.lang.String, char[]):android.content.Intent}
      ClspMth{android.content.Intent.putExtra(java.lang.String, boolean):android.content.Intent} */
    public static void startAppsViewActivity(Integer editModeType, Context context) {
    ...
    public void onCreateAddContent(Bundle savedInstanceState) {
        ...
        ((AppsViewFragment) getFragmentManager().findFragmentByTag(TAG_APPS_VIEW_FRAGMENT)).setOnForceFinishAnimationListener(this);
    }
    ...
    public void onResume() {
        ...
        if (!this.isBlockedForData && getIntent().getBooleanExtra(CHECK_FOR_EDIT_MODE, true)) {
    ...
    public void finish() {
        ...
        if ((fragment == null || !fragment.isResumed()) && !this.forceFinish) {
            super.finish();
            return;
        }
    ...
    private void onShowAppsView() {
        ...
        fragment.setOnForceFinishAnimationListener(this);
        getFragmentManager().beginTransaction().add(16908290, fragment, TAG_APPS_VIEW_FRAGMENT).commit();
    }

    public void onForceFinishAnimation(boolean forceFinishAnimation) {
        this.forceFinish = forceFinishAnimation;
        finish();
    }
}
