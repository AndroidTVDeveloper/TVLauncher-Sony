...
public class HomeRowAnimator extends BoundsItemAnimator {
    ...
    private final Interpolator mainInterpolator = new DecelerateInterpolator();
    ...
    public boolean animateInPlaceChange(final RecyclerView.ViewHolder viewHolder, RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo) {
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator(viewHolder.itemView, preInfo.bounds, postInfo.bounds, this.mainInterpolator));
        ...
        overallAnimation.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                HomeRowAnimator.this.changeAnimationsMap.remove(viewHolder);
                HomeRowAnimator.this.dispatchFinishedWhenDone();
            }
        });
        this.changeAnimationsMap.put(viewHolder, overallAnimation);
    ...
    private void addChannelItemsListAnimations(java.util.List<android.animation.Animator> r7, com.google.android.tvlauncher.home.view.ChannelView r8, com.google.android.tvlauncher.home.view.HomeRowAnimator.MyHolderInfo r9, com.google.android.tvlauncher.home.view.HomeRowAnimator.MyHolderInfo r10) {
        /*
            ...
            android.view.animation.Interpolator r3 = r6.mainInterpolator
        ...
        L_0x0021:
            ...
            android.view.animation.Interpolator r5 = r6.mainInterpolator
    ...
    private void addEmptyChannelMessageAnimations(List<Animator> animators, ChannelView channelView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ...
        if (preInfo.emptyChannelMessageVisibility == 0 && postInfo.emptyChannelMessageVisibility == 0) {
            AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXYAnimator(emptyChannelMessage, preInfo.emptyChannelMessageLeft, preInfo.emptyChannelMessageTop, postInfo.emptyChannelMessageLeft, postInfo.emptyChannelMessageTop, preInfo.emptyChannelMessageTranslationX, preInfo.emptyChannelMessageTranslationY, this.mainInterpolator));
        }
        AnimUtil.addIfNotNull(animators, AnimUtil.createVisibilityAnimator(emptyChannelMessage, preInfo.emptyChannelMessageVisibility, postInfo.emptyChannelMessageVisibility, preInfo.emptyChannelMessageAlpha, this.mainInterpolator));
    }
    ...
    private void addMovingChannelBackgroundAnimations(List<Animator> animators, View backgroundView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        AnimUtil.addIfNotNull(animators, AnimUtil.createVisibilityAnimator(backgroundView, preInfo.movingChannelBackgroundVisibility, postInfo.movingChannelBackgroundVisibility, preInfo.movingChannelBackgroundAlpha, this.mainInterpolator));
    }
    ...
    private void addSponsoredChannelAnimations(List<Animator> animators, ChannelView channelView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXYAnimator(channelLogoImageView, preInfo.logoBounds.left, preInfo.logoBounds.top, postInfo.logoBounds.left, postInfo.logoBounds.top, preInfo.logoTranslationX, preInfo.logoTranslationY, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(channelLogoImageView, preInfo.logoBounds, postInfo.logoBounds, preInfo.logoScale, this.mainInterpolator));
        View sponsoredBackground = channelView.getSponsoredChannelBackground();
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleYAnimator(sponsoredBackground, preInfo.sponsoredChannelBackgroundHeight, postInfo.sponsoredChannelBackgroundHeight, preInfo.sponsoredChannelBackgroundScaleY, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationYAnimator(sponsoredBackground, preInfo.sponsoredChannelBackgroundTop, postInfo.sponsoredChannelBackgroundTop, preInfo.sponsoredChannelBackgroundTranslationY, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createBackgroundColorAnimator(sponsoredBackground, preInfo.sponsoredChannelBackgroundColor, postInfo.sponsoredChannelBackgroundColor, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createVisibilityAnimator(sponsoredBackground, preInfo.sponsoredChannelBackgroundVisibility, postInfo.sponsoredChannelBackgroundVisibility, preInfo.sponsoredChannelBackgroundAlpha, this.mainInterpolator));
    }

    /* access modifiers changed from: private */
    public void cleanUpAfterSponsoredChannelAnimations(ChannelView channelView, MyHolderInfo postInfo) {
    ...
    private void addChannelLogoAnimations(List<Animator> animators, ChannelView channelView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator((View) logo.getParent(), preInfo.logoContainerBounds, postInfo.logoContainerBounds, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(logo, preInfo.logoBounds, postInfo.logoBounds, preInfo.logoScale, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationZAnimator(logo, (float) preInfo.logoElevation, (float) postInfo.logoElevation, preInfo.logoTranslationZ, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXAnimator(logo, preInfo.logoBounds, postInfo.logoBounds, preInfo.logoTranslationX, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationYAnimator(logo, preInfo.logoBounds, postInfo.logoBounds, preInfo.logoTranslationY, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createColorFilterAnimator(logo, ViewCompat.MEASURED_STATE_MASK, preInfo.logoDimmingFactor, postInfo.logoDimmingFactor, this.mainInterpolator));
    }

    /* access modifiers changed from: private */
    public void cleanUpAfterChannelLogoAnimations(ChannelView channelView, MyHolderInfo postInfo) {
        ImageView logo = channelView.getChannelLogoImageView();
    ...
    private void addChannelTitleAnimations(List<Animator> animators, ChannelView channelView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ...
        AnimUtil.addIfNotNull(list, AnimUtil.createTranslationXYAnimator(logoTitle, myHolderInfo.logoTitleLeft, myHolderInfo.logoTitleTop, myHolderInfo2.logoTitleLeft, myHolderInfo2.logoTitleTop, myHolderInfo.logoTitleTranslationX, myHolderInfo.logoTitleTranslationY, this.mainInterpolator));
        ...
        if (myHolderInfo.zoomedOutLogoTitleVisibility == 0 && myHolderInfo2.zoomedOutLogoTitleVisibility == 0) {
            AnimUtil.addIfNotNull(list, AnimUtil.createTextColorAnimator(zoomedOutLogoTitle, myHolderInfo.zoomedOutLogoTitleCurrentColor, myHolderInfo2.zoomedOutLogoTitleStateColor, this.mainInterpolator));
        }
        TextView itemsTitle = channelView.getItemsTitle();
        AnimUtil.addIfNotNull(list, AnimUtil.createTranslationXYAnimator(itemsTitle, myHolderInfo.itemsTitleLeft, myHolderInfo.itemsTitleTop, myHolderInfo2.itemsTitleLeft, myHolderInfo2.itemsTitleTop, myHolderInfo.itemsTitleTranslationX, myHolderInfo.itemsTitleTranslationY, this.mainInterpolator));
        ...
        if (myHolderInfo.itemsTitleVisibility == 0 && myHolderInfo2.itemsTitleVisibility == 0) {
            AnimUtil.addIfNotNull(list, AnimUtil.createTextColorAnimator(itemsTitle, myHolderInfo.itemsTitleCurrentColor, myHolderInfo2.itemsTitleStateColor, this.mainInterpolator));
        }
        View actionsHint = channelView.getActionsHint();
        AnimUtil.addIfNotNull(list, AnimUtil.createTranslationXYAnimator(actionsHint, myHolderInfo.actionsHintLeft, myHolderInfo.actionsHintTop, myHolderInfo2.actionsHintLeft, myHolderInfo2.actionsHintTop, myHolderInfo.actionsHintTranslationX, myHolderInfo.actionsHintTranslationY, this.mainInterpolator));
    ...
    private void addChannelMetadataAnimations(List<Animator> animators, ChannelView channelView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXYAnimator(metaContainer, preInfo.metaContainerLeft, preInfo.metaContainerTop, postInfo.metaContainerLeft, postInfo.metaContainerTop, preInfo.metaContainerTranslationX, preInfo.metaContainerTranslationY, this.mainInterpolator));
    ...
    private void addTopRowAnimations(List<Animator> animators, HomeTopRowView topRowView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ViewGroup itemsContainer = topRowView.getItemsContainer();
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationYAnimator(itemsContainer, preInfo.topRowItemContainerTop, postInfo.topRowItemContainerTop, preInfo.topRowItemContainerTranslationY, this.mainInterpolator));
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationYAnimator(topRowView.getNotificationsTray(), preInfo.topRowNotificationsTrayTop, postInfo.topRowNotificationsTrayTop, preInfo.topRowNotificationsTrayTranslationY, this.mainInterpolator));
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createBackgroundColorAnimator(micOrb.getFocusIndicator(), preInfo.searchViewMicBackgroundColor, postInfo.searchViewMicBackgroundColor, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createBackgroundColorAnimator(keyboardOrb.getFocusIndicator(), preInfo.searchViewKeyboardBackgroundColor, postInfo.searchViewKeyboardBackgroundColor, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(keyboardOrb, preInfo.searchViewKeyboardOrbScale, postInfo.searchViewKeyboardOrbScale, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(micOrb, preInfo.searchViewMicOrbScale, postInfo.searchViewMicOrbScale, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createVisibilityAnimator(searchView.getHotwordDisabledIcon(), preInfo.searchViewHotwordIconVisibility, postInfo.searchViewHotwordIconVisibility, preInfo.searchViewHotwordIconAlpha, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXAnimator(searchView.getTextSwitcher(), preInfo.searchViewTextSwitcherLeft, postInfo.searchViewTextSwitcherLeft, postInfo.searchViewTextSwitcherTranslationX, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXAnimator(searchView.getTextSwitcherContainer(), preInfo.searchViewTextSwitcherContainerLeft, postInfo.searchViewTextSwitcherContainerLeft, postInfo.searchViewTextSwitcherContainerTranslationX, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createVisibilityAnimator(keyboardOrb, preInfo.searchViewKeyboardOrbVisibility, postInfo.searchViewKeyboardOrbVisibility, preInfo.searchViewKeyboardOrbAlpha, this.mainInterpolator));
    }

    /* access modifiers changed from: private */
    public void cleanUpAfterTopRowAnimations(HomeTopRowView topRowView, MyHolderInfo postInfo) {
    ...
    private void addBottomRowAnimations(List<Animator> animators, ConfigureChannelsRowView view, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        for (int i = 0; i < preInfo.bottomRowItemTop.length; i++) {
            AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXYAnimator(view.getChildAt(i), preInfo.bottomRowItemLeft[i], preInfo.bottomRowItemTop[i], postInfo.bottomRowItemLeft[i], postInfo.bottomRowItemTop[i], preInfo.bottomRowItemTranslationX[i], preInfo.bottomRowItemTranslationY[i], this.mainInterpolator));
        }
        AnimUtil.addIfNotNull(animators, AnimUtil.createVisibilityAnimator(view.getDescriptionView(), preInfo.bottomRowDescriptionVisibility, postInfo.bottomRowDescriptionVisibility, postInfo.bottomRowDescriptionAlpha, this.mainInterpolator));
        View button = view.getButton();
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(button, preInfo.bottomRowButtonScale, postInfo.bottomRowButtonScale, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createBackgroundColorAnimator(button, preInfo.bottomRowButtonBackgroundColor, postInfo.bottomRowButtonBackgroundColor, this.mainInterpolator));
    }

    /* access modifiers changed from: private */
    public void cleanUpAfterBottomRowAnimations(ConfigureChannelsRowView view, MyHolderInfo postInfo) {
    ...
    private static class MyHolderInfo extends RecyclerView.ItemAnimator.ItemHolderInfo {
        ...
        public RecyclerView.ItemAnimator.ItemHolderInfo setFrom(RecyclerView.ViewHolder holder, int flags) {
            ...
            if (holder.itemView instanceof ChannelView) {
                ...
                this.searchViewKeyboardOrbAlpha = searchView.getKeyboardOrb().getAlpha();
