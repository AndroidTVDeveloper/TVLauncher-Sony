...
public class PrimesSettings {
    ...
    public boolean isPrimesEnabled() {
        return getGservicesBoolean(this.contentResolver, PRIMES_ENABLED_KEY, false);
    }

    /* access modifiers changed from: package-private */
    public boolean isPackageStatsMetricEnabled() {
        return getGservicesBoolean(this.contentResolver, PRIMES_PACKAGE_STATS_METRIC_ENABLED_KEY, false);
    }

    /* access modifiers changed from: package-private */
    public boolean isMemoryMetricEnabled() {
        return getGservicesBoolean(this.contentResolver, PRIMES_MEMORY_METRIC_ENABLED_KEY, false);
    }

    /* access modifiers changed from: package-private */
    public boolean isCrashMetricEnabled() {
        return getGservicesBoolean(this.contentResolver, PRIMES_CRASH_METRIC_ENABLED_KEY, false);
    }
