...
public class HomeScreenPreferenceFragment extends LeanbackPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        screen.setTitle(C1167R.string.settings_dialog_title);
    ...
    private void createAppsViewPreference(PreferenceScreen screen, Context preferenceContext) {
        ...
        appsCategory.setTitle(C1167R.string.apps_view_title);
        ...
        reorderAppsPref.setTitle(C1167R.string.customize_app_order_action_title);
        ...
        reorderGamesPref.setTitle(C1167R.string.customize_game_order_action_title);
    ...
    private void createGuideViewPreference(PreferenceScreen screen, Context preferenceContext) {
        ...
        guideCategory.setTitle(C1167R.string.guide_view_title);
        screen.addPreference(guideCategory);
        Preference channelsPreference = new Preference(getPreferenceManager().getContext());
        channelsPreference.setTitle(C1167R.string.add_channels_title);
        ...
        previewVideoEnablePref.setTitle(C1167R.string.home_screen_preview_video_enable);
        ...
        previewAudioEnablePref.setTitle(C1167R.string.home_screen_preview_audio_enable);
    ...
    private void createAboutCategory(PreferenceScreen screen, final Context preferenceContext) {
        ...
        aboutCategory.setTitle(C1167R.string.open_source_licenses_title);
        screen.addPreference(aboutCategory);
        Preference launcherLicenses = new Preference(preferenceContext);
        launcherLicenses.setTitle(C1167R.string.app_name);
