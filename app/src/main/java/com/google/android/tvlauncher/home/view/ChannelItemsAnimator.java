...
public class ChannelItemsAnimator extends BoundsItemAnimator {
    ...
    public Set<Animator> canceledAnimations = new HashSet();
    private final Interpolator mainInterpolator;
    ...
    public ChannelItemsAnimator() {
        ...
        this.mainInterpolator = new DecelerateInterpolator();
    }
    ...
    public boolean animateInPlaceChange(final RecyclerView.ViewHolder viewHolder, RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo) {
        Animator runningAnimation = (Animator) this.changeAnimationsMap.get(viewHolder);
        if (runningAnimation != null) {
            this.canceledAnimations.add(runningAnimation);
        }
        ...
        if (viewHolder.itemView instanceof ProgramView) {
            ...
            AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator(programView, preInfo.bounds, postInfo.bounds, this.mainInterpolator));
        ...
        overallAnimation.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                boolean wasCanceled = ChannelItemsAnimator.this.canceledAnimations.remove(animation);
                if (viewHolder.itemView instanceof ProgramView) {
                    ProgramView programView = (ProgramView) viewHolder.itemView;
                ...
                ChannelItemsAnimator.this.changeAnimationsMap.remove(viewHolder);
    ...
    private void addMainContainerAnimations(List<Animator> animators, View view, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        Animator scaleAnimator = AnimUtil.createScaleAnimator(view, preInfo.scale, postInfo.scale, this.mainInterpolator);
        if (scaleAnimator != null) {
            view.setPivotY(Math.max(preInfo.pivotY, postInfo.pivotY));
            animators.add(scaleAnimator);
        }
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationZAnimator(view, preInfo.elevation, postInfo.elevation, preInfo.translationZ, this.mainInterpolator));
    }
    ...
    private void addPreviewImageBackgroundAnimations(List<Animator> animators, ProgramView view, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(previewImageBackground, preInfo.previewImageBackgroundBounds, postInfo.previewImageBackgroundBounds, preInfo.previewImageBackgroundScale, 0.0f, (float) (previewImageBackground.getHeight() / 2), this.mainInterpolator));
    ...
    private void addPreviewImageAnimations(List<Animator> animators, ProgramView view, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator(view.getPreviewImageContainer(), preInfo.previewImageContainerBounds, postInfo.previewImageContainerBounds, this.mainInterpolator));
        ImageView previewImage = view.getPreviewImage();
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(previewImage, preInfo.previewImageBounds, postInfo.previewImageBounds, preInfo.previewImageScale, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXYAnimator(previewImage, preInfo.previewImageBounds.left, preInfo.previewImageBounds.top, postInfo.previewImageBounds.left, postInfo.previewImageBounds.top, preInfo.previewImageTranslationX, preInfo.previewImageTranslationY, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createColorFilterAnimator(previewImage, ViewCompat.MEASURED_STATE_MASK, preInfo.dimmingFactor, postInfo.dimmingFactor, this.mainInterpolator));
    }
    ...
    private void addPreviewDelayAnimations(List<Animator> animators, ProgramView programView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXYAnimator(programView.getPreviewDelayProgress(), preInfo.previewDelayProgressLeft, preInfo.previewDelayProgressTop, postInfo.previewDelayProgressLeft, postInfo.previewDelayProgressTop, preInfo.previewDelayProgressTranslationX, postInfo.previewDelayProgressTranslationY, this.mainInterpolator));
    }
    ...
    private void addPlaybackProgressAnimations(List<Animator> animators, ProgramView programView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleXAnimator(playbackProgressDimmer, preInfo.playbackProgressDimmerWidth, postInfo.playbackProgressDimmerWidth, preInfo.playbackProgressDimmerScaleX, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationYAnimator(playbackProgressDimmer, preInfo.playbackProgressDimmerTop, postInfo.playbackProgressDimmerTop, preInfo.playbackProgressDimmerTranslationY, this.mainInterpolator));
        View playbackProgress = programView.getPlaybackProgress();
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleXAnimator(playbackProgress, preInfo.playbackProgressWidth, postInfo.playbackProgressWidth, preInfo.playbackProgressScaleX, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationYAnimator(playbackProgress, preInfo.playbackProgressTop, postInfo.playbackProgressTop, preInfo.playbackProgressTranslationY, this.mainInterpolator));
    }
    ...
    private void addLogoAnimations(List<Animator> animators, ProgramView programView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator(programView.getLogoAndBadgesContainer(), preInfo.logoAndBadgesContainerBounds, postInfo.logoAndBadgesContainerBounds, this.mainInterpolator));
        View logoDimmer = programView.getLogoDimmer();
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleXAnimator(logoDimmer, preInfo.logoDimmerWidth, postInfo.logoDimmerWidth, preInfo.logoDimmerScaleX, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationYAnimator(logoDimmer, preInfo.logoDimmerTop, postInfo.logoDimmerTop, preInfo.logoDimmerTranslationY, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createVisibilityAnimator(logoDimmer, preInfo.logoDimmerVisibility, postInfo.logoDimmerVisibility, preInfo.logoDimmerAlpha, this.mainInterpolator));
        View logo = programView.getLogo();
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationYAnimator(logo, preInfo.logoTop, postInfo.logoTop, preInfo.logoTranslationY, this.mainInterpolator));
    ...
    private void addBadgeAnimations(List<Animator> animators, ProgramView programView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ...
        AnimUtil.addIfNotNull(list, AnimUtil.createTranslationXYAnimator(liveIcon, myHolderInfo.liveIconLeft, myHolderInfo.liveIconTop, myHolderInfo2.liveIconLeft, myHolderInfo2.liveIconTop, myHolderInfo.liveIconTranslationX, myHolderInfo.liveIconTranslationY, this.mainInterpolator));
    ...
    private void addFavoriteAppsRowViewAnimations(List<Animator> animators, FavoriteLaunchItemView favoriteLaunchItemView, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        ImageView overlayBannerView;
        View view = (View) favoriteLaunchItemView;
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(view, preInfo.scale, postInfo.scale, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createPivotXAnimator(view, preInfo.pivotX, postInfo.pivotX, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationZAnimator(view, preInfo.elevation, postInfo.elevation, preInfo.translationZ, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXYAnimator(view, preInfo.left, preInfo.top, postInfo.left, postInfo.top, preInfo.translationX, preInfo.translationY, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createColorFilterAnimator(favoriteLaunchItemView.getBannerImage(), ViewCompat.MEASURED_STATE_MASK, preInfo.dimmingFactor, postInfo.dimmingFactor, this.mainInterpolator));
        if ((favoriteLaunchItemView instanceof BannerView) && (overlayBannerView = ((BannerView) favoriteLaunchItemView).getOverlayBannerView()) != null) {
            AnimUtil.addIfNotNull(animators, AnimUtil.createColorFilterAnimator(overlayBannerView, ViewCompat.MEASURED_STATE_MASK, preInfo.overlayBannerViewDimmingFactor, postInfo.overlayBannerViewDimmingFactor, this.mainInterpolator));
        }
    ...
    private void addWatchNextInfoViewAnimations(List<Animator> animators, WatchNextInfoView view, MyHolderInfo preInfo, MyHolderInfo postInfo) {
        AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator(view, preInfo.bounds, postInfo.bounds, this.mainInterpolator));
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator(container, preInfo.watchNextInfoContainerBounds, postInfo.watchNextInfoContainerBounds, this.mainInterpolator));
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(container, preInfo.watchNextInfoContainerScale, postInfo.watchNextInfoContainerScale, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator(view.getIconTitleContainer(), preInfo.watchNextInfoIconTitleContainerBounds, postInfo.watchNextInfoIconTitleContainerBounds, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(view.getIcon(), preInfo.watchNextInfoIconBounds, postInfo.watchNextInfoIconBounds, preInfo.watchNextInfoIconScale, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXYAnimator(view.getIcon(), preInfo.watchNextInfoIconBounds.left, preInfo.watchNextInfoIconBounds.top, postInfo.watchNextInfoIconBounds.left, postInfo.watchNextInfoIconBounds.top, preInfo.watchNextInfoIconTranslationX, preInfo.watchNextInfoIconTranslationY, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createAlphaAnimator(view.getIcon(), preInfo.watchNextInfoIconAlpha, postInfo.watchNextInfoIconAlpha, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, createScaleAnimatorBasedOnHeight(view.getTitle(), preInfo.watchNextInfoTitleBounds.height(), postInfo.watchNextInfoTitleBounds.height(), preInfo.watchNextInfoTitleScale, this.mainInterpolator));
        if (Util.isRtl(view.getContext())) {
            AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXAnimator(view.getTitle(), preInfo.watchNextInfoTitleBounds.right, postInfo.watchNextInfoTitleBounds.right, preInfo.watchNextInfoTitleTranslationX, this.mainInterpolator));
        } else {
            AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXAnimator(view.getTitle(), preInfo.watchNextInfoTitleBounds.left, postInfo.watchNextInfoTitleBounds.left, preInfo.watchNextInfoTitleTranslationX, this.mainInterpolator));
        }
        AnimUtil.addIfNotNull(animators, AnimUtil.createTextColorAnimator(view.getTitle(), preInfo.watchNextInfoMessageTextColor, postInfo.watchNextInfoMessageTextColor, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createScaleAnimator(view.getMessage(), preInfo.watchNextInfoMessageScale, postInfo.watchNextInfoMessageScale, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXYAnimator(view.getMessage(), preInfo.watchNextInfoMessageViewBounds.left, preInfo.watchNextInfoMessageViewBounds.top, postInfo.watchNextInfoMessageViewBounds.left, postInfo.watchNextInfoMessageViewBounds.top, preInfo.watchNextInfoMessageTranslationX, preInfo.watchNextInfoMessageTranslationY, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createTextColorAnimator(view.getMessage(), preInfo.watchNextInfoMessageTextColor, postInfo.watchNextInfoMessageTextColor, this.mainInterpolator));
    }
    ...
    private Animator createScaleAnimatorBasedOnHeight(View view, int from, int to, float current, Interpolator interpolator) {
