...
public class NotificationPanelItemAnimator extends BoundsItemAnimator {
    ...
    public boolean animateInPlaceChange(final RecyclerView.ViewHolder viewHolder, RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo) {
        ...
        AnimUtil.addIfNotNull(animators, AnimUtil.createTranslationXAnimator(itemContainer, preInfo.itemContainerLeft, postInfo.itemContainerLeft, preInfo.itemsContainerTranslationX, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator(title, preInfo.titleBounds, postInfo.titleBounds, this.mainInterpolator));
        AnimUtil.addIfNotNull(animators, AnimUtil.createBoundsAnimator(text, preInfo.textBounds, postInfo.textBounds, this.mainInterpolator));
        ...
        overallAnimation.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                NotificationPanelItemAnimator.this.changeAnimationsMap.remove(viewHolder);
    ...
    public void cleanUpAfterAnimations(NotificationPanelItemView view, NotifItemHolderInfo postInfo) {
