...
final /* synthetic */ class LaunchOnBootCompletedHelper$$Lambda$0 implements LaunchOnBootCompletedHelper.SetLoadedDataCallback {
    ...
    public void setLoadedData(boolean z, boolean z2, boolean z3, String str, String str2) {
        this.arg$1.lambda$loadLaunchOnBootFlagsAsync$0$LaunchOnBootCompletedHelper(z, z2, z3, str, str2);
    }
}
