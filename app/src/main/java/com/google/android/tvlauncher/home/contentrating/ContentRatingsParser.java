...
public class ContentRatingsParser {
    ...
    private String xmlVersionCode;

    public ContentRatingsParser(Context context2) {
    ...
    public java.util.List<com.google.android.tvlauncher.home.contentrating.ContentRatingSystem> parse(android.media.tv.TvContentRatingSystemInfo r10) {
        /*
            ...
            java.lang.String r2 = r1.getAuthority()     // Catch:{ Exception -> 0x0064 }
            long r3 = android.content.ContentUris.parseId(r1)     // Catch:{ Exception -> 0x0064 }
            int r4 = (int) r3     // Catch:{ Exception -> 0x0064 }
            android.content.Context r3 = r9.context     // Catch:{ Exception -> 0x0064 }
            android.content.pm.PackageManager r3 = r3.getPackageManager()     // Catch:{ Exception -> 0x0064 }
            r5 = 0
            android.content.res.XmlResourceParser r3 = r3.getXml(r2, r4, r5)     // Catch:{ Exception -> 0x0064 }
            if (r3 == 0) goto L_0x0032
            boolean r5 = r10.isSystemDefined()     // Catch:{ all -> 0x0030 }
        ...
        L_0x0024:
            r5 = 0
        L_0x0025:
            java.util.List r5 = r9.parse(r3, r2, r5)     // Catch:{ all -> 0x0030 }
            r0 = r5
        ...
        L_0x0030:
            ...
            goto L_0x0057
        L_0x0032:
            java.lang.IllegalArgumentException r5 = new java.lang.IllegalArgumentException     // Catch:{ all -> 0x0030 }
            java.lang.String r6 = java.lang.String.valueOf(r1)     // Catch:{ all -> 0x0030 }
            java.lang.String r7 = java.lang.String.valueOf(r6)     // Catch:{ all -> 0x0030 }
            int r7 = r7.length()     // Catch:{ all -> 0x0030 }
            int r7 = r7 + 24
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ all -> 0x0030 }
            r8.<init>(r7)     // Catch:{ all -> 0x0030 }
            java.lang.String r7 = "Cannot get XML with URI "
            r8.append(r7)     // Catch:{ all -> 0x0030 }
            r8.append(r6)     // Catch:{ all -> 0x0030 }
            java.lang.String r6 = r8.toString()     // Catch:{ all -> 0x0030 }
        ...
        L_0x005f:
            r7 = move-exception
            com.google.devtools.build.android.desugar.runtime.ThrowableExtension.addSuppressed(r5, r7)     // Catch:{ Exception -> 0x0064 }
        L_0x0063:
            throw r6     // Catch:{ Exception -> 0x0064 }
        L_0x0064:
            r2 = move-exception
    ...
    private List<ContentRatingSystem> parse(XmlResourceParser parser, String domain, boolean isCustom) throws XmlPullParserException, IOException {
        ...
        for (int i = 0; i < parser.getAttributeCount(); i++) {
            if (ATTR_VERSION_CODE.equals(parser.getAttributeName(i))) {
                hasVersionAttr = true;
                this.xmlVersionCode = parser.getAttributeValue(i);
            }
        }
        if (hasVersionAttr) {
    ...
    private void checkVersion(String msg) throws XmlPullParserException {
        if (!"1".equals(this.xmlVersionCode)) {
            throw new XmlPullParserException(msg);
        }
    }
    ...
    private com.google.android.tvlauncher.home.contentrating.ContentRatingSystem parseRatingSystemDefinition(android.content.res.XmlResourceParser r12, java.lang.String r13, boolean r14) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x004f:
            ...
            goto L_0x00b0
        L_0x007c:
            android.content.res.Resources r3 = r11.resources
    ...
    private String getTitle(XmlResourceParser parser, int index) {
        ...
        if (titleResId != 0) {
            return this.resources.getString(titleResId);
        }
