...
public enum FieldType {
    ...
    private FieldType(int id, Collection collection2, JavaType javaType2) {
        ...
        int i2 = C19181.$SwitchMap$com$google$protobuf$FieldType$Collection[collection2.ordinal()];
        if (i2 == 1) {
        ...
        if (!(collection2 != Collection.SCALAR || (i = C19181.$SwitchMap$com$google$protobuf$JavaType[javaType2.ordinal()]) == 1 || i == 2 || i == 3)) {
