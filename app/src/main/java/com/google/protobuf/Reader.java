...
interface Reader {
    ...
    @Deprecated
    <T> T readGroup(Class cls, ExtensionRegistryLite extensionRegistryLite) throws IOException;
    ...
    @Deprecated
    <T> void readGroupList(List list, Class cls, ExtensionRegistryLite extensionRegistryLite) throws IOException;
    ...
    <T> T readMessage(Class cls, ExtensionRegistryLite extensionRegistryLite) throws IOException;
    ...
    <T> void readMessageList(List list, Class cls, ExtensionRegistryLite extensionRegistryLite) throws IOException;
