...
final class C1945x94510305 extends ExtensionRegistryLite {
        ...
        switch (c) {
            case 0:
                switch (i) {
                    ...
                    case VersionAnnotations.VERSION_RANGE_LIST_FIELD_NUMBER:
            ...
            case 1:
                switch (i) {
                    ...
                    case VersionAnnotations.VERSION_LOG_FIELD_NUMBER:
