...
abstract class BinaryReader implements Reader {
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        /* JADX INFO: Multiple debug info for r1v7 'i'  int: [D('i' int), D('x' int)] */
        /* JADX INFO: Multiple debug info for r0v7 int: [D('i' int), D('x' int)] */
        /* JADX INFO: Multiple debug info for r1v11 'x'  int: [D('i' int), D('x' int)] */
            ...
            if (i3 != this.pos) {
                ...
                if (b >= 0) {
                    ...
                    if (i6 < 0) {
                        ...
                        i = i5 + 1;
                        int i7 = (bArr[i5] << Ascii.f181SO) ^ x3;
                        int x4 = i7;
                        if (i7 >= 0) {
                            x = x4 ^ 16256;
                        } else {
                            int x5 = i + 1;
                            int i8 = (bArr[i] << Ascii.NAK) ^ x4;
                            int x6 = i8;
                            if (i8 < 0) {
                                x = -2080896 ^ x6;
                                i = x5;
                                ...
                                i = x5 + 1;
                                byte b2 = bArr[x5];
                                x = (x6 ^ (b2 << Ascii.f174FS)) ^ 266354560;
                                if (b2 < 0) {
                                    int i9 = i + 1;
                                    if (bArr[i] < 0) {
                                        i = i9 + 1;
            ...
            if (i2 != i) {
                ...
                if (b >= 0) {
                    ...
                    if (i5 < 0) {
                        ...
                        int i6 = i4 + 1;
                        int i7 = (buffer2[i4] << Ascii.f181SO) ^ y2;
                        int y3 = i7;
                        if (i7 >= 0) {
                            x = (long) (y3 ^ 16256);
                            i4 = i6;
