...
final class MessageSchema<T> implements Schema<T> {
    ...
    /* JADX INFO: Multiple debug info for r3v5 int: [D('hasBitsIndex' int), D('presenceMaskShift' int)] */
    /* JADX INFO: Multiple debug info for r9v24 int: [D('i' int), D('oneofIndex' int)] */
    /* JADX INFO: Multiple debug info for r1v24 ?: [D('o' java.lang.Object), D('length' int)] */
    /* JADX INFO: Multiple debug info for r7v14 int: [D('oneofCount' int), D('result' int)] */
    ...
    /* JADX INFO: Multiple debug info for r12v3 int: [D('numEntries' int), D('result' int)] */
    /* JADX INFO: Multiple debug info for r11v5 int: [D('result' int), D('mapFieldCount' int)] */
    /* JADX INFO: Multiple debug info for r13v5 char: [D('result' int), D('repeatedFieldCount' int)] */
    /* JADX INFO: Multiple debug info for r14v4 int: [D('result' int), D('checkInitialized' int)] */
    ...
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo messageInfo, NewInstanceSchema newInstanceSchema2, ListFieldSchema listFieldSchema2, UnknownFieldSchema<?, ?> unknownFieldSchema2, ExtensionSchema<?> extensionSchema2, MapFieldSchema mapFieldSchema2) {
        ...
        if (fis.length == 0) {
            ...
            int minFieldNumber3 = fis[0].getFieldNumber();
            maxFieldNumber2 = fis[fis.length - 1].getFieldNumber();
            minFieldNumber2 = minFieldNumber3;
        }
        ...
        for (FieldInfo fi : fis) {
            if (fi.getType() == FieldType.MAP) {
                mapFieldCount++;
            } else if (fi.getType().mo29346id() >= 18 && fi.getType().mo29346id() <= 49) {
                repeatedFieldCount++;
            }
        }
        ...
        while (fieldIndex < fis.length) {
            ...
            } else if (fi2.getType().mo29346id() < 18 || fi2.getType().mo29346id() > 49) {
                checkInitializedIndex = checkInitializedIndex2;
            } else {
                checkInitializedIndex = checkInitializedIndex2;
    ...
    /* JADX INFO: Multiple debug info for r1v4 com.google.protobuf.FieldType: [D('typeId' int), D('type' com.google.protobuf.FieldType)] */
    ...
    private int getSerializedSizeProto2(T message) {
        ...
        while (i < this.buffer.length) {
            ...
            } else if (this.useCachedSizeField && fieldType >= FieldType.DOUBLE_LIST_PACKED.mo29346id() && fieldType <= FieldType.SINT64_LIST_PACKED.mo29346id()) {
    ...
    private int getSerializedSizeProto3(T message) {
        ...
        for (int i = 0; i < this.buffer.length; i += 3) {
            ...
            int number = numberAt(i);
            long offset = offset(typeAndOffset);
            if (fieldType < FieldType.DOUBLE_LIST_PACKED.mo29346id() || fieldType > FieldType.SINT64_LIST_PACKED.mo29346id()) {
                cachedSizeOffset = 0;
            } else {
    ...
    /* JADX INFO: Multiple debug info for r0v3 byte: [D('position' int), D('tag' int)] */
    /* JADX INFO: Multiple debug info for r11v4 int: [D('wireType' int), D('length' int)] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* JADX INFO: Multiple debug info for r4v1 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r6v1 long: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v2 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r6v2 long: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v3 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r6v3 long: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v4 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r6v4 long: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v5 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r6v5 long: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v6 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r6v6 long: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v7 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r6v7 long: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v8 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r6v8 long: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v9 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r6v9 long: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v10 sun.misc.Unsafe: [D('unsafe' sun.misc.Unsafe), D('oneofCaseOffset' long)] */
    ...
    /* JADX INFO: Multiple debug info for r0v5 byte: [D('position' int), D('tag' int)] */
    ...
    /* JADX INFO: Multiple debug info for r10v7 long: [D('fieldOffset' long), D('unsafe' sun.misc.Unsafe)] */
    /* JADX INFO: Multiple debug info for r8v5 int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    ...
    /* JADX INFO: Multiple debug info for r8v20 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    ...
    /* JADX INFO: Multiple debug info for r8v22 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    ...
    /* JADX INFO: Multiple debug info for r8v24 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    ...
    /* JADX INFO: Multiple debug info for r8v27 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    /* JADX INFO: Multiple debug info for r10v21 long: [D('unsafe' sun.misc.Unsafe), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r8v29 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    /* JADX INFO: Multiple debug info for r3v28 int: [D('fieldType' int), D('tag' int)] */
    ...
    /* JADX INFO: Multiple debug info for r8v31 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    /* JADX INFO: Multiple debug info for r3v30 int: [D('fieldType' int), D('tag' int)] */
    /* JADX INFO: Multiple debug info for r10v25 long: [D('unsafe' sun.misc.Unsafe), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r8v33 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    /* JADX INFO: Multiple debug info for r3v32 int: [D('fieldType' int), D('tag' int)] */
    /* JADX INFO: Multiple debug info for r10v27 long: [D('unsafe' sun.misc.Unsafe), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r8v35 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    /* JADX INFO: Multiple debug info for r3v34 int: [D('fieldType' int), D('tag' int)] */
    /* JADX INFO: Multiple debug info for r10v29 long: [D('unsafe' sun.misc.Unsafe), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r8v37 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    /* JADX INFO: Multiple debug info for r10v31 long: [D('unsafe' sun.misc.Unsafe), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r8v39 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    /* JADX INFO: Multiple debug info for r10v33 long: [D('unsafe' sun.misc.Unsafe), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r8v41 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    /* JADX INFO: Multiple debug info for r10v36 long: [D('unsafe' sun.misc.Unsafe), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r8v45 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    /* JADX INFO: Multiple debug info for r8v47 'position'  int: [D('currentPresenceFieldOffset' int), D('position' int)] */
    ...
    /* JADX INFO: Multiple debug info for r0v3 byte: [D('position' int), D('tag' int)] */
    /* JADX INFO: Multiple debug info for r8v1 long: [D('fieldOffset' long), D('number' int)] */
    /* JADX INFO: Multiple debug info for r22v1 int: [D('typeAndOffset' int), D('number' int)] */
    ...
    /* JADX INFO: Multiple debug info for r4v8 sun.misc.Unsafe: [D('typeAndOffset' int), D('unsafe' sun.misc.Unsafe)] */
    ...
    /* JADX INFO: Multiple debug info for r8v9 int: [D('typeAndOffset' int), D('number' int)] */
    /* JADX INFO: Multiple debug info for r4v12 long: [D('typeAndOffset' int), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v14 long: [D('typeAndOffset' int), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v15 long: [D('typeAndOffset' int), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r8v14 int: [D('typeAndOffset' int), D('number' int)] */
    /* JADX INFO: Multiple debug info for r4v16 long: [D('typeAndOffset' int), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v17 long: [D('typeAndOffset' int), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v18 long: [D('typeAndOffset' int), D('fieldOffset' long)] */
    /* JADX INFO: Multiple debug info for r4v19 long: [D('typeAndOffset' int), D('fieldOffset' long)] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* JADX INFO: Multiple debug info for r0v1 int: [D('typeAndOffset' int), D('presenceMaskAndOffset' int)] */
