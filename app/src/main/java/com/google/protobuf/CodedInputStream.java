...
public abstract class CodedInputStream {
    ...
    private static final class ArrayDecoder extends CodedInputStream {
        ...
        /* JADX INFO: Multiple debug info for r1v7 'tempPos'  int: [D('tempPos' int), D('x' int)] */
        /* JADX INFO: Multiple debug info for r0v8 int: [D('tempPos' int), D('x' int)] */
        /* JADX INFO: Multiple debug info for r1v11 'x'  int: [D('tempPos' int), D('x' int)] */
        /* JADX INFO: Multiple debug info for r0v9 byte: [D('y' int), D('tempPos' int)] */
            ...
            if (this.limit != tempPos) {
                ...
                if (i >= 0) {
                    ...
                    if (i2 < 0) {
                        ...
                        x = tempPos3 + 1;
                        int i3 = (UnsafeUtil.getByte(tempPos3) << Ascii.f181SO) ^ y2;
                        int y3 = i3;
                        if (i3 >= 0) {
                            x2 = (long) (y3 ^ 16256);
                        } else {
