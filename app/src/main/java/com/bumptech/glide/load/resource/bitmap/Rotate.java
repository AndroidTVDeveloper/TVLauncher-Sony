...
public class Rotate extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f67ID = "com.bumptech.glide.load.resource.bitmap.Rotate";
    private static final byte[] ID_BYTES = f67ID.getBytes(CHARSET);
    ...
    public int hashCode() {
        return Util.hashCode(f67ID.hashCode(), Util.hashCode(this.degreesToRotate));
    }
