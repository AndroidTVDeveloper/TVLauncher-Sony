...
public class ByteBufferGifDecoder implements ResourceDecoder<ByteBuffer, GifDrawable> {
    ...
    private com.bumptech.glide.load.resource.gif.GifDrawableResource decode(java.nio.ByteBuffer r23, int r24, int r25, com.bumptech.glide.gifdecoder.GifHeaderParser r26, com.bumptech.glide.load.Options r27) {
        /*
            ...
            r6 = 51
            r7 = 2
            com.bumptech.glide.gifdecoder.GifHeader r0 = r26.parseHeader()     // Catch:{ all -> 0x00e5 }
            int r8 = r0.getNumFrames()     // Catch:{ all -> 0x00e5 }
            if (r8 <= 0) goto L_0x00c0
            int r8 = r0.getStatus()     // Catch:{ all -> 0x00e5 }
            if (r8 == 0) goto L_0x0023
            r9 = r23
            r10 = r27
            goto L_0x00c4
        L_0x0023:
            com.bumptech.glide.load.Option<com.bumptech.glide.load.DecodeFormat> r8 = com.bumptech.glide.load.resource.gif.GifOptions.DECODE_FORMAT     // Catch:{ all -> 0x00e5 }
            r10 = r27
            java.lang.Object r8 = r10.get(r8)     // Catch:{ all -> 0x00bc }
            com.bumptech.glide.load.DecodeFormat r11 = com.bumptech.glide.load.DecodeFormat.PREFER_RGB_565     // Catch:{ all -> 0x00bc }
            if (r8 != r11) goto L_0x0032
            android.graphics.Bitmap$Config r8 = android.graphics.Bitmap.Config.RGB_565     // Catch:{ all -> 0x00bc }
            goto L_0x0034
        L_0x0032:
            android.graphics.Bitmap$Config r8 = android.graphics.Bitmap.Config.ARGB_8888     // Catch:{ all -> 0x00bc }
        L_0x0034:
            r15 = r24
            r13 = r25
            int r11 = getSampleSize(r0, r15, r13)     // Catch:{ all -> 0x00bc }
            r12 = r11
            com.bumptech.glide.load.resource.gif.ByteBufferGifDecoder$GifDecoderFactory r11 = r1.gifDecoderFactory     // Catch:{ all -> 0x00bc }
            com.bumptech.glide.load.resource.gif.GifBitmapProvider r14 = r1.provider     // Catch:{ all -> 0x00bc }
            r9 = r23
            com.bumptech.glide.gifdecoder.GifDecoder r11 = r11.build(r14, r0, r9, r12)     // Catch:{ all -> 0x00ba }
            r11.setDefaultBitmapConfig(r8)     // Catch:{ all -> 0x00ba }
            r11.advance()     // Catch:{ all -> 0x00ba }
            android.graphics.Bitmap r14 = r11.getNextFrame()     // Catch:{ all -> 0x00ba }
            r18 = r14
        ...
        L_0x007a:
            r19 = r8
            com.bumptech.glide.load.resource.UnitTransformation r14 = com.bumptech.glide.load.resource.UnitTransformation.get()     // Catch:{ all -> 0x00ba }
            com.bumptech.glide.load.resource.gif.GifDrawable r8 = new com.bumptech.glide.load.resource.gif.GifDrawable     // Catch:{ all -> 0x00ba }
            android.content.Context r6 = r1.context     // Catch:{ all -> 0x00ba }
            r20 = r11
            r11 = r8
            r21 = r12
            r12 = r6
            ...
            r16 = r25
            r17 = r18
            r11.<init>(r12, r13, r14, r15, r16, r17)     // Catch:{ all -> 0x00ba }
            r6 = r8
            com.bumptech.glide.load.resource.gif.GifDrawableResource r8 = new com.bumptech.glide.load.resource.gif.GifDrawableResource     // Catch:{ all -> 0x00ba }
            r8.<init>(r6)     // Catch:{ all -> 0x00ba }
            boolean r7 = android.util.Log.isLoggable(r3, r7)
