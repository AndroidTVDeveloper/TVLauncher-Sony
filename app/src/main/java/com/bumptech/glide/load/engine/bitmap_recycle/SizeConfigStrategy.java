...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    static {
        ...
        L_0x0021:
            ...
            android.graphics.Bitmap$Config[] r0 = com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.ARGB_8888_IN_CONFIGS
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config requested) {
        ...
        int i = C08021.$SwitchMap$android$graphics$Bitmap$Config[requested.ordinal()];
        if (i == 1) {
