...
public final class RoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f68ID = "com.bumptech.glide.load.resource.bitmap.RoundedCorners";
    private static final byte[] ID_BYTES = f68ID.getBytes(CHARSET);
    ...
    public int hashCode() {
        return Util.hashCode(f68ID.hashCode(), Util.hashCode(this.roundingRadius));
    }
