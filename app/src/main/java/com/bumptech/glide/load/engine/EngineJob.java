...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    /* access modifiers changed from: package-private */
    public void callCallbackOnResourceReady(ResourceCallback cb) {
        try {
    ...
    /* access modifiers changed from: package-private */
    public void callCallbackOnLoadFailed(ResourceCallback cb) {
        try {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0055, code lost:
        r4 = r3.next();
        r4.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r8, r4.f59cb));
     */
    ...
    public void notifyCallbacksOfResult() {
        ...
        L_0x004f:
            ...
            com.bumptech.glide.request.ResourceCallback r7 = r4.f59cb
            r6.<init>(r7)
            r5.execute(r6)
            goto L_0x004f
        L_0x0068:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r3 = r0.next();
        r3.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r7, r3.f59cb));
     */
    ...
    public void notifyCallbacksOfException() {
        ...
        L_0x0039:
            ...
            com.bumptech.glide.request.ResourceCallback r6 = r3.f59cb
            r5.<init>(r6)
            r4.execute(r5)
            goto L_0x0039
        L_0x0052:
    ...
    private class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f57cb;
        ...
        public void run() {
            synchronized (this.f57cb) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f57cb)) {
                        EngineJob.this.callCallbackOnLoadFailed(this.f57cb);
                    }
    ...
    private class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f58cb;
        ...
        public void run() {
            synchronized (this.f58cb) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f58cb)) {
                        EngineJob.this.engineResource.acquire();
                        EngineJob.this.callCallbackOnResourceReady(this.f58cb);
                        EngineJob.this.removeCallback(this.f58cb);
                    }
                    EngineJob.this.decrementPendingCallbacks();
                }
            }
    ...
    static final class ResourceCallbackAndExecutor {
        ...
        public boolean equals(Object o) {
            if (o instanceof ResourceCallbackAndExecutor) {
                return this.f59cb.equals(((ResourceCallbackAndExecutor) o).f59cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f59cb.hashCode();
        }
    }
