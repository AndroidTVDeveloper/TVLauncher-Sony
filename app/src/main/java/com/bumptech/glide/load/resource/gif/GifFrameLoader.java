...
class GifFrameLoader {
    ...
    GifFrameLoader(Glide glide, GifDecoder gifDecoder2, int width2, int height2, Transformation<Bitmap> transformation2, Bitmap firstFrame2) {
        this(glide.getBitmapPool(), Glide.with(glide.getContext()), gifDecoder2, null, getRequestBuilder(Glide.with(glide.getContext()), width2, height2), transformation2, firstFrame2);
    }
    ...
    public void setFrameTransformation(Transformation<Bitmap> transformation2, Bitmap firstFrame2) {
        ...
        this.firstFrameSize = Util.getBitmapByteSize(firstFrame2);
        this.width = firstFrame2.getWidth();
        this.height = firstFrame2.getHeight();
    }
    ...
    private static RequestBuilder<Bitmap> getRequestBuilder(RequestManager requestManager2, int width2, int height2) {
        return requestManager2.asBitmap().apply((BaseRequestOptions<?>) ((RequestOptions) ((RequestOptions) RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE).useAnimationPool(true)).skipMemoryCache(true)).override(width2, height2));
    }
