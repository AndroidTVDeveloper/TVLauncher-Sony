...
public class DecodePath<DataType, ResourceType, Transcode> {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: MethodInvokeVisitor
        ...
        */
    public com.bumptech.glide.load.engine.Resource<Transcode> decode(com.bumptech.glide.load.data.DataRewinder<DataType> r4, int r5, int r6, com.bumptech.glide.load.Options r7, com.bumptech.glide.load.engine.DecodePath.DecodeCallback<ResourceType> r8) throws com.bumptech.glide.load.engine.GlideException {
        /*
            r3 = this;
