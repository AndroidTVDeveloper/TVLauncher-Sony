...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    private void runWrapped() {
        int i = C07931.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C07931.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage current) {
        int i = C07931.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[current.ordinal()];
        if (i != 1) {
            if (i == 2) {
    ...
    public <Z> Resource<Z> onResourceDecoded(DataSource dataSource, Resource<Z> decoded) {
        ...
        if (encoder != null) {
            int i = C07931.$SwitchMap$com$bumptech$glide$load$EncodeStrategy[encodeStrategy.ordinal()];
            if (i == 1) {
                encoder2 = encoder;
