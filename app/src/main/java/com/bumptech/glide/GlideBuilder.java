...
public final class GlideBuilder {
    ...
    public GlideBuilder setDefaultRequestOptions(final RequestOptions requestOptions) {
        return setDefaultRequestOptions(new Glide.RequestOptionsFactory(this) {
            public RequestOptions build() {
    ...
    public GlideBuilder setHardwareBitmapFdLimitOnPPlus(int limit) {
        this.hardwareBitmapFdLimit = limit;
        return this;
    }
