...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback, FactoryPools.Poolable {
    ...
    private synchronized boolean listenerCountEquals(com.bumptech.glide.request.SingleRequest<?> r4) {
        /*
            ...
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r3.requestListeners     // Catch:{ all -> 0x0021 }
            r1 = 0
        ...
        L_0x000f:
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r2 = r4.requestListeners     // Catch:{ all -> 0x0021 }
