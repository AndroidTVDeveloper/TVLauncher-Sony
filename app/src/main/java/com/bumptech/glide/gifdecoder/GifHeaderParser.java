...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f52ix = readShort();
        this.header.currentFrame.f53iy = readShort();
        this.header.currentFrame.f51iw = readShort();
        this.header.currentFrame.f50ih = readShort();
        int packed = read();
        boolean z = false;
