...
public class GlideContext extends ContextWrapper {
    ...
    public GlideContext(Context context, ArrayPool arrayPool2, Registry registry2, ImageViewTargetFactory imageViewTargetFactory2, Glide.RequestOptionsFactory defaultRequestOptionsFactory2, Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions2, List<RequestListener<Object>> defaultRequestListeners2, Engine engine2, boolean isLoggingRequestOriginsEnabled2, int logLevel2) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public <X> com.bumptech.glide.request.target.ViewTarget<android.widget.ImageView, X> buildImageViewTarget(android.widget.ImageView r2, java.lang.Class<X> r3) {
        /*
            r1 = this;
