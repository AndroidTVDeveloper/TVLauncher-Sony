...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: com.bumptech.glide.ListPreloader.preload(int, boolean):void
     arg types: [int, int]
     candidates:
      com.bumptech.glide.ListPreloader.preload(int, int):void
      com.bumptech.glide.ListPreloader.preload(int, boolean):void */
