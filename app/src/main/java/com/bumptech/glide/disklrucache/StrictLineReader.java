...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f47CR = 13;

    /* renamed from: LF */
    private static final byte f48LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f49in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f49in;
        byte[] bArr = this.buf;
