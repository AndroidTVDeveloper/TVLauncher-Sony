...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private static void findAllSupportFragmentsWithViews(Collection<android.support.p001v4.app.Fragment> topLevelFragments, Map<View, android.support.p001v4.app.Fragment> result) {
    ...
    private android.support.p001v4.app.Fragment findSupportFragment(android.view.View r5, android.support.p001v4.app.FragmentActivity r6) {
        /*
            r4 = this;
    ...
    /* access modifiers changed from: package-private */
    public SupportRequestManagerFragment getSupportRequestManagerFragment(Context context, android.support.p001v4.app.FragmentManager fragmentManager) {
    ...
    private SupportRequestManagerFragment getSupportRequestManagerFragment(android.support.p001v4.app.FragmentManager fm, android.support.p001v4.app.Fragment parentHint, boolean isParentVisible) {
    ...
    private RequestManager supportFragmentGet(Context context, android.support.p001v4.app.FragmentManager fm, android.support.p001v4.app.Fragment parentHint, boolean isParentVisible) {
